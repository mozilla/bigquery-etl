...
IF
  NOT EXISTS `moz-fx-data-shared-prod.org_mozilla_firefox_beta_derived.experiment_ad_clicks_count_live_v1`
  OPTIONS
  ...
  WITH desktop AS (
    SELECT
      ...
      browser_search_ad_clicks.value AS ad_clicks_count
    FROM
