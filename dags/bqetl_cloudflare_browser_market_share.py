...
with DAG(
    ...
    checks__warn_cloudflare_derived__browser_usage__v1 = bigquery_dq_check(
        task_id="checks__warn_cloudflare_derived__browser_usage__v1",
        source_table="browser_usage_v1",
    ...
    checks__warn_cloudflare_derived__browser_usage__v1.set_upstream(
        cloudflare_derived__browser_usage__v1
    )
