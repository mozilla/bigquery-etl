...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus.server_deletion_request`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus_stable.server_deletion_request_v1`
