...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_desktop_background_defaultagent.health`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_desktop_background_defaultagent_stable.health_v1`
