...
with DAG(
    ...
    with TaskGroup("bq_main_events_task_markers") as bq_main_events_task_markers:
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_bq_main_events",
            execution_date="{{ (logical_date + macros.timedelta(seconds=11700)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_bq_main_events",
            execution_date="{{ (logical_date + macros.timedelta(seconds=56400)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_bq_main_events",
            execution_date="{{ (logical_date + macros.timedelta(seconds=54000)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_bq_main_events",
            execution_date="{{ (logical_date + macros.timedelta(seconds=3600)).isoformat() }}",
        )
    ...
    with TaskGroup(
        ...
        ExternalTaskMarker(
            ...
            execution_date="{{ (logical_date + macros.timedelta(seconds=5400)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=18000)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=67200)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=10800)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=75600)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=82500)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=50400)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=21600)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=39600)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=16200)).isoformat() }}",
        )
        ...
        ExternalTaskMarker(
            ...
            external_task_id="wait_for_copy_deduplicate_all",
            execution_date="{{ (logical_date + macros.timedelta(seconds=25200)).isoformat() }}",
        )
