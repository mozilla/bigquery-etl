...
The Google Search Console exports for a date typically complete by 08:00 UTC three days after that date,
so these ETLs should generally specify `date_partition_offset: -2` in their scheduling metadata.
