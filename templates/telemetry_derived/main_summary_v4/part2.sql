WITH histogram_lists AS (
  SELECT
    ...
    ARRAY(
      SELECT AS STRUCT
        udf_json_extract_int_map(JSON_EXTRACT(histogram, '$.values')) AS histogram
      FROM
        UNNEST([
...
SELECT
  * EXCEPT(
  ...
  values_histograms[OFFSET(0)].histogram AS histogram_parent_a11y_consumers,
  values_histograms[OFFSET(1)].histogram AS histogram_parent_cert_validation_success_by_ca,
  values_histograms[OFFSET(2)].histogram AS histogram_content_cert_validation_success_by_ca,
  values_histograms[OFFSET(3)].histogram AS histogram_parent_checkerboard_severity,
  values_histograms[OFFSET(4)].histogram AS histogram_content_checkerboard_severity,
  values_histograms[OFFSET(5)].histogram AS histogram_gpu_checkerboard_severity,
  values_histograms[OFFSET(6)].histogram AS histogram_parent_composite_time,
  values_histograms[OFFSET(7)].histogram AS histogram_content_composite_time,
  values_histograms[OFFSET(8)].histogram AS histogram_gpu_composite_time,
  values_histograms[OFFSET(9)].histogram AS histogram_gpu_content_frame_time,
  values_histograms[OFFSET(10)].histogram AS histogram_parent_content_paint_time,
  values_histograms[OFFSET(11)].histogram AS histogram_content_content_paint_time,
  values_histograms[OFFSET(12)].histogram AS histogram_parent_cookie_behavior,
  values_histograms[OFFSET(13)].histogram AS histogram_parent_cycle_collector_max_pause,
  values_histograms[OFFSET(14)].histogram AS histogram_content_cycle_collector_max_pause,
  values_histograms[OFFSET(15)].histogram AS histogram_parent_devtools_accessibility_picker_time_active_seconds,
  values_histograms[OFFSET(16)].histogram AS histogram_content_devtools_accessibility_picker_time_active_seconds,
  values_histograms[OFFSET(17)].histogram AS histogram_parent_devtools_accessibility_service_time_active_seconds,
  values_histograms[OFFSET(18)].histogram AS histogram_content_devtools_accessibility_service_time_active_seconds,
  values_histograms[OFFSET(19)].histogram AS histogram_parent_devtools_accessibility_time_active_seconds,
  values_histograms[OFFSET(10)].histogram AS histogram_content_devtools_accessibility_time_active_seconds,
  values_histograms[OFFSET(21)].histogram AS histogram_parent_devtools_fonteditor_n_fonts_rendered,
  values_histograms[OFFSET(22)].histogram AS histogram_parent_devtools_fonteditor_n_font_axes,
  values_histograms[OFFSET(23)].histogram AS histogram_parent_devtools_toolbox_time_active_seconds,
  values_histograms[OFFSET(24)].histogram AS histogram_content_devtools_toolbox_time_active_seconds,
  values_histograms[OFFSET(25)].histogram AS histogram_parent_dns_failed_lookup_time,
  values_histograms[OFFSET(26)].histogram AS histogram_parent_dns_lookup_time,
  values_histograms[OFFSET(27)].histogram AS histogram_parent_fx_new_window_ms,
  values_histograms[OFFSET(28)].histogram AS histogram_parent_fx_page_load_ms_2,
  values_histograms[OFFSET(29)].histogram AS histogram_content_fx_page_load_ms_2,
  values_histograms[OFFSET(30)].histogram AS histogram_parent_fx_session_restore_restore_window_ms,
  values_histograms[OFFSET(31)].histogram AS histogram_parent_fx_session_restore_startup_init_session_ms,
  values_histograms[OFFSET(32)].histogram AS histogram_parent_fx_session_restore_startup_onload_initial_window_ms,
  values_histograms[OFFSET(33)].histogram AS histogram_parent_fx_tab_close_time_anim_ms,
  values_histograms[OFFSET(34)].histogram AS histogram_parent_fx_tab_switch_total_e10s_ms,
  values_histograms[OFFSET(35)].histogram AS histogram_parent_fx_tab_switch_update_ms,
  values_histograms[OFFSET(36)].histogram AS histogram_parent_fx_urlbar_selected_result_index,
  values_histograms[OFFSET(37)].histogram AS histogram_content_fx_urlbar_selected_result_index,
  values_histograms[OFFSET(38)].histogram AS histogram_parent_fx_urlbar_selected_result_type,
  values_histograms[OFFSET(39)].histogram AS histogram_content_fx_urlbar_selected_result_type,
  values_histograms[OFFSET(40)].histogram AS histogram_parent_gc_animation_ms,
  values_histograms[OFFSET(41)].histogram AS histogram_content_gc_animation_ms,
  values_histograms[OFFSET(42)].histogram AS histogram_parent_gc_max_pause_ms_2,
  values_histograms[OFFSET(43)].histogram AS histogram_content_gc_max_pause_ms_2,
  values_histograms[OFFSET(44)].histogram AS histogram_parent_geolocation_request_granted,
  values_histograms[OFFSET(45)].histogram AS histogram_content_geolocation_request_granted,
  values_histograms[OFFSET(46)].histogram AS histogram_parent_ghost_windows,
  values_histograms[OFFSET(47)].histogram AS histogram_content_ghost_windows,
  values_histograms[OFFSET(48)].histogram AS histogram_parent_gpu_process_initialization_time_ms,
  values_histograms[OFFSET(49)].histogram AS histogram_content_gpu_process_initialization_time_ms,
  values_histograms[OFFSET(50)].histogram AS histogram_gpu_gpu_process_initialization_time_ms,
  values_histograms[OFFSET(51)].histogram AS histogram_parent_gpu_process_launch_time_ms_2,
  values_histograms[OFFSET(52)].histogram AS histogram_content_gpu_process_launch_time_ms_2,
  values_histograms[OFFSET(53)].histogram AS histogram_parent_http_channel_disposition,
  values_histograms[OFFSET(54)].histogram AS histogram_content_http_channel_disposition,
  values_histograms[OFFSET(55)].histogram AS histogram_parent_http_pageload_is_ssl,
  values_histograms[OFFSET(56)].histogram AS histogram_content_http_pageload_is_ssl,
  values_histograms[OFFSET(57)].histogram AS histogram_parent_http_transaction_is_ssl,
  values_histograms[OFFSET(58)].histogram AS histogram_content_http_transaction_is_ssl,
  values_histograms[OFFSET(59)].histogram AS histogram_parent_input_event_response_coalesced_ms,
  values_histograms[OFFSET(60)].histogram AS histogram_content_input_event_response_coalesced_ms,
  values_histograms[OFFSET(61)].histogram AS histogram_parent_memory_heap_allocated,
  values_histograms[OFFSET(62)].histogram AS histogram_content_memory_heap_allocated,
  values_histograms[OFFSET(63)].histogram AS histogram_parent_memory_resident_fast,
  values_histograms[OFFSET(64)].histogram AS histogram_content_memory_resident_fast,
  values_histograms[OFFSET(65)].histogram AS histogram_parent_memory_total,
  values_histograms[OFFSET(66)].histogram AS histogram_parent_memory_unique,
  values_histograms[OFFSET(67)].histogram AS histogram_content_memory_unique,
  values_histograms[OFFSET(68)].histogram AS histogram_content_memory_unique_content_startup,
  values_histograms[OFFSET(69)].histogram AS histogram_parent_memory_vsize,
  values_histograms[OFFSET(70)].histogram AS histogram_content_memory_vsize,
  values_histograms[OFFSET(71)].histogram AS histogram_parent_memory_vsize_max_contiguous,
  values_histograms[OFFSET(72)].histogram AS histogram_content_memory_vsize_max_contiguous,
  values_histograms[OFFSET(73)].histogram AS histogram_parent_network_cache_metadata_first_read_time_ms,
  values_histograms[OFFSET(74)].histogram AS histogram_content_network_cache_metadata_first_read_time_ms,
  values_histograms[OFFSET(75)].histogram AS histogram_parent_network_cache_v2_hit_time_ms,
  values_histograms[OFFSET(76)].histogram AS histogram_content_network_cache_v2_hit_time_ms,
  values_histograms[OFFSET(77)].histogram AS histogram_parent_network_cache_v2_miss_time_ms,
  values_histograms[OFFSET(78)].histogram AS histogram_content_network_cache_v2_miss_time_ms,
  values_histograms[OFFSET(79)].histogram AS histogram_parent_places_autocomplete_6_first_results_time_ms,
  values_histograms[OFFSET(80)].histogram AS histogram_parent_plugin_shutdown_ms,
  values_histograms[OFFSET(81)].histogram AS histogram_content_plugin_shutdown_ms,
  values_histograms[OFFSET(82)].histogram AS histogram_parent_pwmgr_blocklist_num_sites,
  values_histograms[OFFSET(83)].histogram AS histogram_parent_pwmgr_form_autofill_result,
  values_histograms[OFFSET(84)].histogram AS histogram_content_pwmgr_form_autofill_result,
  values_histograms[OFFSET(85)].histogram AS histogram_parent_pwmgr_login_last_used_days,
  values_histograms[OFFSET(86)].histogram AS histogram_parent_pwmgr_login_page_safety,
  values_histograms[OFFSET(87)].histogram AS histogram_content_pwmgr_login_page_safety,
  values_histograms[OFFSET(88)].histogram AS histogram_parent_pwmgr_manage_opened,
  values_histograms[OFFSET(89)].histogram AS histogram_parent_pwmgr_manage_visibility_toggled,
  values_histograms[OFFSET(90)].histogram AS histogram_parent_pwmgr_num_passwords_per_hostname,
  values_histograms[OFFSET(91)].histogram AS histogram_parent_pwmgr_num_saved_passwords,
  values_histograms[OFFSET(92)].histogram AS histogram_parent_pwmgr_prompt_remember_action,
  values_histograms[OFFSET(93)].histogram AS histogram_parent_pwmgr_prompt_update_action,
  values_histograms[OFFSET(94)].histogram AS histogram_parent_pwmgr_saving_enabled,
  values_histograms[OFFSET(95)].histogram AS histogram_parent_search_service_init_ms,
  values_histograms[OFFSET(96)].histogram AS histogram_parent_ssl_handshake_result,
  values_histograms[OFFSET(97)].histogram AS histogram_content_ssl_handshake_result,
  values_histograms[OFFSET(98)].histogram AS histogram_parent_ssl_handshake_version,
  values_histograms[OFFSET(99)].histogram AS histogram_content_ssl_handshake_version,
  values_histograms[OFFSET(100)].histogram AS histogram_parent_ssl_tls12_intolerance_reason_pre,
  values_histograms[OFFSET(101)].histogram AS histogram_content_ssl_tls12_intolerance_reason_pre,
  values_histograms[OFFSET(102)].histogram AS histogram_parent_ssl_tls13_intolerance_reason_pre,
  values_histograms[OFFSET(103)].histogram AS histogram_content_ssl_tls13_intolerance_reason_pre,
  values_histograms[OFFSET(104)].histogram AS histogram_content_time_to_dom_complete_ms,
  values_histograms[OFFSET(105)].histogram AS histogram_content_time_to_dom_content_loaded_end_ms,
  values_histograms[OFFSET(106)].histogram AS histogram_content_time_to_dom_content_loaded_start_ms,
  values_histograms[OFFSET(107)].histogram AS histogram_content_time_to_dom_interactive_ms,
  values_histograms[OFFSET(108)].histogram AS histogram_content_time_to_dom_loading_ms,
  values_histograms[OFFSET(109)].histogram AS histogram_parent_time_to_first_click_ms,
  values_histograms[OFFSET(110)].histogram AS histogram_content_time_to_first_click_ms,
  values_histograms[OFFSET(111)].histogram AS histogram_parent_time_to_first_interaction_ms,
  values_histograms[OFFSET(112)].histogram AS histogram_content_time_to_first_interaction_ms,
  values_histograms[OFFSET(113)].histogram AS histogram_parent_time_to_first_key_input_ms,
  values_histograms[OFFSET(114)].histogram AS histogram_content_time_to_first_key_input_ms,
  values_histograms[OFFSET(115)].histogram AS histogram_parent_time_to_first_mouse_move_ms,
  values_histograms[OFFSET(116)].histogram AS histogram_content_time_to_first_mouse_move_ms,
  values_histograms[OFFSET(117)].histogram AS histogram_parent_time_to_first_scroll_ms,
  values_histograms[OFFSET(118)].histogram AS histogram_content_time_to_first_scroll_ms,
  values_histograms[OFFSET(119)].histogram AS histogram_content_time_to_load_event_end_ms,
  values_histograms[OFFSET(120)].histogram AS histogram_content_time_to_load_event_start_ms,
  values_histograms[OFFSET(121)].histogram AS histogram_parent_time_to_non_blank_paint_ms,
  values_histograms[OFFSET(122)].histogram AS histogram_content_time_to_non_blank_paint_ms,
  values_histograms[OFFSET(123)].histogram AS histogram_parent_time_to_response_start_ms,
  values_histograms[OFFSET(124)].histogram AS histogram_content_time_to_response_start_ms,
  values_histograms[OFFSET(125)].histogram AS histogram_parent_touch_enabled_device,
  values_histograms[OFFSET(126)].histogram AS histogram_parent_tracking_protection_enabled,
  values_histograms[OFFSET(127)].histogram AS histogram_parent_update_download_code_partial,
  values_histograms[OFFSET(128)].histogram AS histogram_parent_update_download_code_complete,
  values_histograms[OFFSET(129)].histogram AS histogram_parent_update_bits_result_partial,
  values_histograms[OFFSET(130)].histogram AS histogram_parent_update_bits_result_complete,
  values_histograms[OFFSET(131)].histogram AS histogram_parent_update_state_code_partial_stage,
  values_histograms[OFFSET(132)].histogram AS histogram_parent_update_state_code_complete_stage,
  values_histograms[OFFSET(133)].histogram AS histogram_parent_update_status_error_code_complete_stage,
  values_histograms[OFFSET(134)].histogram AS histogram_parent_update_status_error_code_partial_stage,
  values_histograms[OFFSET(135)].histogram AS histogram_parent_update_state_code_partial_startup,
  values_histograms[OFFSET(136)].histogram AS histogram_parent_update_state_code_complete_startup,
  values_histograms[OFFSET(137)].histogram AS histogram_parent_update_status_error_code_partial_startup,
  values_histograms[OFFSET(138)].histogram AS histogram_parent_update_status_error_code_complete_startup,
  values_histograms[OFFSET(139)].histogram AS histogram_parent_webext_background_page_load_ms,
  values_histograms[OFFSET(140)].histogram AS histogram_parent_webext_browseraction_popup_open_ms,
  values_histograms[OFFSET(141)].histogram AS histogram_parent_webext_content_script_injection_ms,
  values_histograms[OFFSET(142)].histogram AS histogram_content_webext_content_script_injection_ms,
  values_histograms[OFFSET(143)].histogram AS histogram_parent_webext_extension_startup_ms,
  values_histograms[OFFSET(144)].histogram AS histogram_parent_webext_pageaction_popup_open_ms,
  values_histograms[OFFSET(145)].histogram AS histogram_parent_webext_storage_local_get_ms,
  values_histograms[OFFSET(146)].histogram AS histogram_content_webext_storage_local_get_ms,
  values_histograms[OFFSET(147)].histogram AS histogram_parent_webext_storage_local_set_ms,
  values_histograms[OFFSET(148)].histogram AS histogram_content_webext_storage_local_set_ms,
  values_histograms[OFFSET(149)].histogram AS histogram_parent_webvr_time_spent_viewing_in_2d,
  values_histograms[OFFSET(150)].histogram AS histogram_content_webvr_time_spent_viewing_in_2d,
  values_histograms[OFFSET(151)].histogram AS histogram_parent_webvr_time_spent_viewing_in_oculus,
  values_histograms[OFFSET(152)].histogram AS histogram_gpu_webvr_time_spent_viewing_in_oculus,
  values_histograms[OFFSET(153)].histogram AS histogram_parent_webvr_time_spent_viewing_in_openvr,
  values_histograms[OFFSET(154)].histogram AS histogram_gpu_webvr_time_spent_viewing_in_openvr,
  values_histograms[OFFSET(155)].histogram AS histogram_parent_webvr_users_view_in,
  values_histograms[OFFSET(156)].histogram AS histogram_gpu_webvr_users_view_in,
  values_histograms[OFFSET(157)].histogram AS histogram_content_webvr_users_view_in,
  values_histograms[OFFSET(158)].histogram AS histogram_parent_a11y_instantiated_flag,
  values_histograms[OFFSET(159)].histogram AS histogram_parent_search_reset_result,
  values_histograms[OFFSET(160)].histogram AS histogram_content_search_reset_result,
  values_histograms[OFFSET(161)].histogram AS histogram_parent_gc_max_pause_ms,
  values_histograms[OFFSET(162)].histogram AS histogram_content_gc_max_pause_ms,
  values_histograms[OFFSET(163)].histogram AS histogram_parent_content_frame_time,
  values_histograms[OFFSET(164)].histogram AS histogram_content_tracking_protection_enabled,
  values_histograms[OFFSET(165)].histogram AS histogram_content_places_autocomplete_6_first_results_time_ms,
  values_histograms[OFFSET(166)].histogram AS histogram_content_memory_total,
  values_histograms[OFFSET(167)].histogram AS histogram_content_fx_session_restore_restore_window_ms,
  values_histograms[OFFSET(168)].histogram AS histogram_content_fx_session_restore_startup_init_session_ms,
  values_histograms[OFFSET(169)].histogram AS histogram_content_fx_session_restore_startup_onload_initial_window_ms,
  values_histograms[OFFSET(170)].histogram AS histogram_content_fx_tab_close_time_anim_ms,
  values_histograms[OFFSET(171)].histogram AS histogram_content_fx_tab_switch_update_ms,
  values_histograms[OFFSET(172)].histogram AS histogram_content_fx_new_window_ms,
  values_histograms[OFFSET(173)].histogram AS histogram_content_search_service_init_ms,
  keyed_values_histograms[OFFSET(0)].histogram AS histogram_content_fx_urlbar_selected_result_index_by_type,
  keyed_values_histograms[OFFSET(1)].histogram AS histogram_parent_fx_urlbar_selected_result_index_by_type,
  keyed_values_histograms[OFFSET(2)].histogram AS histogram_content_ipc_read_main_thread_latency_ms,
  keyed_values_histograms[OFFSET(3)].histogram AS histogram_gpu_ipc_read_main_thread_latency_ms,
  keyed_values_histograms[OFFSET(4)].histogram AS histogram_parent_ipc_read_main_thread_latency_ms,
  keyed_values_histograms[OFFSET(5)].histogram AS histogram_parent_memory_distribution_among_content,
  keyed_values_histograms[OFFSET(6)].histogram AS histogram_content_memory_distribution_among_content,
  ...
  keyed_count_histograms[OFFSET(0)].histogram AS histogram_content_sandbox_rejected_syscalls,
  keyed_count_histograms[OFFSET(1)].histogram AS histogram_parent_sandbox_rejected_syscalls,
  categorical_histograms[OFFSET(0)].histogram AS histogram_content_fx_searchbar_selected_result_method,
  categorical_histograms[OFFSET(1)].histogram AS histogram_parent_fx_searchbar_selected_result_method,
  categorical_histograms[OFFSET(2)].histogram AS histogram_parent_devtools_about_devtools_opened_key,
  categorical_histograms[OFFSET(3)].histogram AS histogram_parent_devtools_about_devtools_opened_reason,
  categorical_histograms[OFFSET(4)].histogram AS histogram_parent_devtools_entry_point,
  categorical_histograms[OFFSET(5)].histogram AS histogram_parent_devtools_fonteditor_font_type_displayed,
  categorical_histograms[OFFSET(6)].histogram AS histogram_content_fx_urlbar_selected_result_method,
  categorical_histograms[OFFSET(7)].histogram AS histogram_parent_fx_urlbar_selected_result_method,
  categorical_histograms[OFFSET(8)].histogram AS histogram_parent_update_can_use_bits_notify,
  categorical_histograms[OFFSET(9)].histogram AS histogram_parent_webext_browseraction_popup_preload_result_count,
  keyed_categorical_histograms[OFFSET(0)].histogram AS histogram_content_uptake_remote_content_result_1,
  keyed_categorical_histograms[OFFSET(1)].histogram AS histogram_gpu_uptake_remote_content_result_1,
  keyed_categorical_histograms[OFFSET(2)].histogram AS histogram_parent_uptake_remote_content_result_1
FROM
  histogram_lists
