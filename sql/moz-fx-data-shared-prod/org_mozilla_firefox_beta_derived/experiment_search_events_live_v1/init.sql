CREATE OR REPLACE MATERIALIZED VIEW `moz-fx-data-shared-prod.org_mozilla_fenix_beta_derived.experiment_search_events_live_v1`
AS
WITH fenix AS (
  SELECT
  ...
  FROM
    `moz-fx-data-shared-prod.org_mozilla_fenix_beta_live.metrics_v1`,
