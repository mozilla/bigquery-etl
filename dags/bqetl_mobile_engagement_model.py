...
Built from bigquery-etl repo, [`dags/bqetl_mobile_engagement_model.py`](https://github.com/mozilla/bigquery-etl/blob/generated-sql/dags/bqetl_mobile_engagement_model.py)

#### Description

Loads the mobile engagement model tables
#### Owner
...
default_args = {
    ...
    "start_date": datetime.datetime(2024, 5, 16, 0, 0),
    "end_date": None,
...
with DAG(
    ...
    telemetry_derived__mobile_engagement__v1 = bigquery_etl_query(
        task_id="telemetry_derived__mobile_engagement__v1",
        destination_table="mobile_engagement_v1",
    ...
    telemetry_derived__mobile_engagement_clients__v1 = bigquery_etl_query(
        task_id="telemetry_derived__mobile_engagement_clients__v1",
        destination_table="mobile_engagement_clients_v1",
        dataset_id="telemetry_derived",
        project_id="moz-fx-data-shared-prod",
        owner="kwindau@mozilla.com",
        email=["kwindau@mozilla.com", "telemetry-alerts@mozilla.com"],
    ...
    telemetry_derived__mobile_engagement__v1.set_upstream(
