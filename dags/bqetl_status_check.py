...
Built from bigquery-etl repo, [`dags/bqetl_status_check.py`](https://github.com/mozilla/bigquery-etl/blob/main/dags/bqetl_status_check.py)
...
default_args = {
    ...
    "end_date": None,
    "email": ["telemetry-alerts@mozilla.com", "data-platform-infra-wg@mozilla.com"],
