...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.fx_accounts_client_info`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_enterprise_desktop_stable.fx_accounts_client_info_v1`
