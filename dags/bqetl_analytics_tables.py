...
with DAG(
    ...
    with TaskGroup(
        ...
        ExternalTaskMarker(
            task_id="bqetl_fx_health_ind_dashboard__wait_for_bigeye__firefox_desktop_derived__desktop_dau_distribution_id_history__v1",
        ...
        ExternalTaskMarker(
            task_id="bqetl_firefox_desktop_new_profiles_aggregates__wait_for_bigeye__firefox_desktop_derived__desktop_dau_distribution_id_history__v1",
        ...
        ExternalTaskMarker(
            task_id="bqetl_desktop_conv_evnt_categorization__wait_for_bigeye__firefox_desktop_derived__desktop_dau_distribution_id_history__v1",
    ...
    with TaskGroup(
        ...
        ExternalTaskMarker(
            task_id="private_bqetl_device_partnerships__wait_for_checks__fail_fenix_derived__firefox_android_clients__v1",
    ...
    with TaskGroup(
        ...
        ExternalTaskMarker(
            task_id="bqetl_ga4_firefoxdotcom__wait_for_clients_first_seen_v3",
            external_dag_id="bqetl_ga4_firefoxdotcom",
            external_task_id="wait_for_clients_first_seen_v3",
            execution_date="{{ (execution_date - macros.timedelta(days=-1, seconds=43200)).isoformat() }}",
        )
