  ...
  * EXCEPT (event_id),
  STRUCT(
    STRUCT(
      ...
      LAX_BOOL(event_extra.autocomplete) AS `autocomplete`,
      LAX_BOOL(event_extra.baseline) AS `baseline`,
      LAX_BOOL(event_extra.block) AS `block`,
      ...
      LAX_BOOL(event_extra.data_fetched) AS `data_fetched`,
      ...
      LAX_BOOL(event_extra.did_user_confirm) AS `did_user_confirm`,
      LAX_BOOL(event_extra.enabled) AS `enabled`,
      LAX_BOOL(event_extra.engine_available) AS `engine_available`,
      ...
      LAX_BOOL(event_extra.had_form_data) AS `had_form_data`,
      ...
      LAX_BOOL(event_extra.is_private_default) AS `is_private_default`,
      ...
      LAX_BOOL(event_extra.is_selected) AS `is_selected`,
      ...
      LAX_BOOL(event_extra.sent_from_firefox_enabled) AS `sent_from_firefox_enabled`,
      ...
      LAX_BOOL(event_extra.tab_selected) AS `tab_selected`,
    ...
    STRUCT(
      ...
      LAX_INT64(event_extra.available_count) AS `available_count`,
      ...
      LAX_INT64(event_extra.http_status_code) AS `http_status_code`,
      ...
      LAX_INT64(event_extra.inactive_tabs_count) AS `inactive_tabs_count`,
      ...
      LAX_INT64(event_extra.items_changed_count) AS `items_changed_count`,
      ...
      LAX_INT64(event_extra.number_of_app_launches) AS `number_of_app_launches`,
      ...
      LAX_INT64(event_extra.tou_version) AS `tou_version`,
      LAX_INT64(event_extra.value) AS `value`,
      LAX_INT64(event_extra.visible_duration_ms) AS `visible_duration_ms`,
    ...
    STRUCT(
      ...
      JSON_VALUE(event_extra.app_package) AS `app_package`,
      JSON_VALUE(event_extra.auto_admin) AS `auto_admin`,
      JSON_VALUE(event_extra.autoplay_setting) AS `autoplay_setting`,
      ...
      JSON_VALUE(event_extra.collection_name) AS `collection_name`,
      JSON_VALUE(event_extra.color) AS `color`,
      ...
      JSON_VALUE(event_extra.date) AS `date`,
      JSON_VALUE(event_extra.deal_id) AS `deal_id`,
      JSON_VALUE(event_extra.death_description) AS `death_description`,
      ...
      JSON_VALUE(event_extra.element_type) AS `element_type`,
      ...
      JSON_VALUE(event_extra.extra) AS `extra`,
      ...
      JSON_VALUE(event_extra.from_screen) AS `from_screen`,
      ...
      JSON_VALUE(event_extra.importance) AS `importance`,
      ...
      JSON_VALUE(event_extra.install_source) AS `install_source`,
      ...
      JSON_VALUE(event_extra.link) AS `link`,
      JSON_VALUE(event_extra.local_datetime) AS `local_datetime`,
      ...
      JSON_VALUE(event_extra.old_icon) AS `old_icon`,
      ...
      JSON_VALUE(event_extra.page_number) AS `page_number`,
      ...
      JSON_VALUE(event_extra.permissions) AS `permissions`,
      ...
      JSON_VALUE(event_extra.preference_key) AS `preference_key`,
      ...
      JSON_VALUE(event_extra.process_type) AS `process_type`,
      ...
      JSON_VALUE(event_extra.selected_total) AS `selected_total`,
      ...
      JSON_VALUE(event_extra.signature_type) AS `signature_type`,
      ...
      JSON_VALUE(event_extra.slug_id) AS `slug_id`,
      JSON_VALUE(event_extra.slug_ids) AS `slug_ids`,
      ...
      JSON_VALUE(event_extra.spoc_id) AS `spoc_id`,
      ...
      JSON_VALUE(event_extra.support) AS `support`,
      ...
      JSON_VALUE(event_extra.tab_group_color_changed) AS `tab_group_color_changed`,
      ...
      JSON_VALUE(event_extra.tabs_open) AS `tabs_open`,
      JSON_VALUE(event_extra.tabs_selected) AS `tabs_selected`,
      JSON_VALUE(event_extra.target_type) AS `target_type`,
      JSON_VALUE(event_extra.target_version) AS `target_version`,
      JSON_VALUE(event_extra.task_id) AS `task_id`,
      ...
      JSON_VALUE(event_extra.theme_collection) AS `theme_collection`,
      JSON_VALUE(event_extra.theme_option) AS `theme_option`,
      JSON_VALUE(event_extra.time) AS `time`,
      JSON_VALUE(event_extra.time_created) AS `time_created`,
      JSON_VALUE(event_extra.time_group) AS `time_group`,
      ...
      JSON_VALUE(event_extra.times_shown) AS `times_shown`,
      ...
      JSON_VALUE(event_extra.toolbar_placement) AS `toolbar_placement`,
      JSON_VALUE(event_extra.toolbar_type) AS `toolbar_type`,
