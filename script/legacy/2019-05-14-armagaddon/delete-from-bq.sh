...
./script/generate_incremental_table --destination_table clients_last_seen_v1 --start 2019-05-04 --end 2019-05-15 --dataset=telemetry sql/clients_last_seen_v1.sql
./script/generate_incremental_table --destination_table clients_last_seen_raw_v1 --start 2019-05-04 --end 2019-05-15 --dataset=telemetry sql/clients_last_seen_raw_v1.sql
