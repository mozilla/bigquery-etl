...
* `generate_per_app_id(self, project_id, baseline_table, app_name, app_id_info)`: This method is for generating the per-`app_id` queries
* `generate_per_app(self, project_id, app_name, app_ids_info)`: This method is for generating the per-app queries
