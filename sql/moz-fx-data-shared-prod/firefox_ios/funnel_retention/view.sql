...
FROM
  `moz-fx-data-shared-prod.firefox_ios_derived.funnel_retention_week_2_v1` AS retention_week_2
FULL OUTER JOIN
  `moz-fx-data-shared-prod.firefox_ios_derived.funnel_retention_week_4_v1` AS retention_week_4
USING
