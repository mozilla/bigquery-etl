...
SELECT
  ...
  assert.equals("2018010100", glam.format_build_hour("00010000")),
  assert.equals("2020060514", glam.format_build_hour("21571434")),
    -- new format
  assert.equals("2020081304", glam.format_build_hour("2015757667"))
