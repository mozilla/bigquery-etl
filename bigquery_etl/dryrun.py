...
SKIP = {
    ...
    "sql/apple_app_store/metrics_by_app_referrer/view.sql",
    "sql/apple_app_store/metrics_by_app_version/view.sql",
    "sql/apple_app_store/metrics_by_campaign/view.sql",
    "sql/apple_app_store/metrics_by_platform/view.sql",
    "sql/apple_app_store/metrics_by_platform_version/view.sql",
    "sql/apple_app_store/metrics_by_region/view.sql",
    "sql/apple_app_store/metrics_by_source/view.sql",
    "sql/apple_app_store/metrics_by_storefront/view.sql",
    "sql/apple_app_store/metrics_by_web_referrer/view.sql",
    "sql/apple_app_store/metrics_total/view.sql",
