...
SELECT
  submission_date AS submission_date_s3,
  * REPLACE (
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_cert_validation_success_by_ca) AS histogram_content_cert_validation_success_by_ca,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_checkerboard_severity) AS histogram_content_checkerboard_severity,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_composite_time) AS histogram_content_composite_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_content_paint_time) AS histogram_content_content_paint_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_cycle_collector_max_pause) AS histogram_content_cycle_collector_max_pause,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_devtools_accessibility_picker_time_active_seconds) AS histogram_content_devtools_accessibility_picker_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_devtools_accessibility_service_time_active_seconds) AS histogram_content_devtools_accessibility_service_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_devtools_accessibility_time_active_seconds) AS histogram_content_devtools_accessibility_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_devtools_toolbox_time_active_seconds) AS histogram_content_devtools_toolbox_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_new_window_ms) AS histogram_content_fx_new_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_page_load_ms_2) AS histogram_content_fx_page_load_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_searchbar_selected_result_method) AS histogram_content_fx_searchbar_selected_result_method,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_session_restore_restore_window_ms) AS histogram_content_fx_session_restore_restore_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_session_restore_startup_init_session_ms) AS histogram_content_fx_session_restore_startup_init_session_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_session_restore_startup_onload_initial_window_ms) AS histogram_content_fx_session_restore_startup_onload_initial_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_tab_close_time_anim_ms) AS histogram_content_fx_tab_close_time_anim_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_tab_switch_update_ms) AS histogram_content_fx_tab_switch_update_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_urlbar_selected_result_index) AS histogram_content_fx_urlbar_selected_result_index,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_urlbar_selected_result_index_by_type) AS histogram_content_fx_urlbar_selected_result_index_by_type,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_urlbar_selected_result_method) AS histogram_content_fx_urlbar_selected_result_method,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_fx_urlbar_selected_result_type) AS histogram_content_fx_urlbar_selected_result_type,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_gc_animation_ms) AS histogram_content_gc_animation_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_gc_max_pause_ms) AS histogram_content_gc_max_pause_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_gc_max_pause_ms_2) AS histogram_content_gc_max_pause_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_geolocation_request_granted) AS histogram_content_geolocation_request_granted,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ghost_windows) AS histogram_content_ghost_windows,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_gpu_process_initialization_time_ms) AS histogram_content_gpu_process_initialization_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_gpu_process_launch_time_ms_2) AS histogram_content_gpu_process_launch_time_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_http_channel_disposition) AS histogram_content_http_channel_disposition,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_http_pageload_is_ssl) AS histogram_content_http_pageload_is_ssl,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_http_transaction_is_ssl) AS histogram_content_http_transaction_is_ssl,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_input_event_response_coalesced_ms) AS histogram_content_input_event_response_coalesced_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ipc_read_main_thread_latency_ms) AS histogram_content_ipc_read_main_thread_latency_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_distribution_among_content) AS histogram_content_memory_distribution_among_content,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_heap_allocated) AS histogram_content_memory_heap_allocated,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_resident_fast) AS histogram_content_memory_resident_fast,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_total) AS histogram_content_memory_total,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_unique) AS histogram_content_memory_unique,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_unique_content_startup) AS histogram_content_memory_unique_content_startup,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_vsize) AS histogram_content_memory_vsize,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_memory_vsize_max_contiguous) AS histogram_content_memory_vsize_max_contiguous,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_network_cache_metadata_first_read_time_ms) AS histogram_content_network_cache_metadata_first_read_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_network_cache_v2_hit_time_ms) AS histogram_content_network_cache_v2_hit_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_network_cache_v2_miss_time_ms) AS histogram_content_network_cache_v2_miss_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_places_autocomplete_6_first_results_time_ms) AS histogram_content_places_autocomplete_6_first_results_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_plugin_shutdown_ms) AS histogram_content_plugin_shutdown_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_pwmgr_form_autofill_result) AS histogram_content_pwmgr_form_autofill_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_pwmgr_login_page_safety) AS histogram_content_pwmgr_login_page_safety,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_sandbox_rejected_syscalls) AS histogram_content_sandbox_rejected_syscalls,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_search_reset_result) AS histogram_content_search_reset_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_search_service_init_ms) AS histogram_content_search_service_init_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ssl_handshake_result) AS histogram_content_ssl_handshake_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ssl_handshake_version) AS histogram_content_ssl_handshake_version,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ssl_tls12_intolerance_reason_pre) AS histogram_content_ssl_tls12_intolerance_reason_pre,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_ssl_tls13_intolerance_reason_pre) AS histogram_content_ssl_tls13_intolerance_reason_pre,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_dom_complete_ms) AS histogram_content_time_to_dom_complete_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_dom_content_loaded_end_ms) AS histogram_content_time_to_dom_content_loaded_end_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_dom_content_loaded_start_ms) AS histogram_content_time_to_dom_content_loaded_start_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_dom_interactive_ms) AS histogram_content_time_to_dom_interactive_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_dom_loading_ms) AS histogram_content_time_to_dom_loading_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_first_click_ms) AS histogram_content_time_to_first_click_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_first_interaction_ms) AS histogram_content_time_to_first_interaction_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_first_key_input_ms) AS histogram_content_time_to_first_key_input_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_first_mouse_move_ms) AS histogram_content_time_to_first_mouse_move_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_first_scroll_ms) AS histogram_content_time_to_first_scroll_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_load_event_end_ms) AS histogram_content_time_to_load_event_end_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_load_event_start_ms) AS histogram_content_time_to_load_event_start_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_non_blank_paint_ms) AS histogram_content_time_to_non_blank_paint_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_time_to_response_start_ms) AS histogram_content_time_to_response_start_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_tracking_protection_enabled) AS histogram_content_tracking_protection_enabled,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_uptake_remote_content_result_1) AS histogram_content_uptake_remote_content_result_1,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_webext_content_script_injection_ms) AS histogram_content_webext_content_script_injection_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_webext_storage_local_get_ms) AS histogram_content_webext_storage_local_get_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_webext_storage_local_set_ms) AS histogram_content_webext_storage_local_set_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_webvr_time_spent_viewing_in_2d) AS histogram_content_webvr_time_spent_viewing_in_2d,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_content_webvr_users_view_in) AS histogram_content_webvr_users_view_in,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_checkerboard_severity) AS histogram_gpu_checkerboard_severity,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_composite_time) AS histogram_gpu_composite_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_content_frame_time) AS histogram_gpu_content_frame_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_gpu_process_initialization_time_ms) AS histogram_gpu_gpu_process_initialization_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_ipc_read_main_thread_latency_ms) AS histogram_gpu_ipc_read_main_thread_latency_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_uptake_remote_content_result_1) AS histogram_gpu_uptake_remote_content_result_1,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_webvr_time_spent_viewing_in_oculus) AS histogram_gpu_webvr_time_spent_viewing_in_oculus,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_webvr_time_spent_viewing_in_openvr) AS histogram_gpu_webvr_time_spent_viewing_in_openvr,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_gpu_webvr_users_view_in) AS histogram_gpu_webvr_users_view_in,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_a11y_consumers) AS histogram_parent_a11y_consumers,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_a11y_instantiated_flag) AS histogram_parent_a11y_instantiated_flag,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_cert_validation_success_by_ca) AS histogram_parent_cert_validation_success_by_ca,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_checkerboard_severity) AS histogram_parent_checkerboard_severity,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_composite_time) AS histogram_parent_composite_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_content_frame_time) AS histogram_parent_content_frame_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_content_paint_time) AS histogram_parent_content_paint_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_cookie_behavior) AS histogram_parent_cookie_behavior,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_cycle_collector_max_pause) AS histogram_parent_cycle_collector_max_pause,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_about_devtools_opened_key) AS histogram_parent_devtools_about_devtools_opened_key,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_about_devtools_opened_reason) AS histogram_parent_devtools_about_devtools_opened_reason,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_accessibility_picker_time_active_seconds) AS histogram_parent_devtools_accessibility_picker_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_accessibility_service_time_active_seconds) AS histogram_parent_devtools_accessibility_service_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_accessibility_time_active_seconds) AS histogram_parent_devtools_accessibility_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_entry_point) AS histogram_parent_devtools_entry_point,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_fonteditor_font_type_displayed) AS histogram_parent_devtools_fonteditor_font_type_displayed,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_fonteditor_n_font_axes) AS histogram_parent_devtools_fonteditor_n_font_axes,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_fonteditor_n_fonts_rendered) AS histogram_parent_devtools_fonteditor_n_fonts_rendered,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_devtools_toolbox_time_active_seconds) AS histogram_parent_devtools_toolbox_time_active_seconds,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_dns_failed_lookup_time) AS histogram_parent_dns_failed_lookup_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_dns_lookup_time) AS histogram_parent_dns_lookup_time,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_new_window_ms) AS histogram_parent_fx_new_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_page_load_ms_2) AS histogram_parent_fx_page_load_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_searchbar_selected_result_method) AS histogram_parent_fx_searchbar_selected_result_method,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_session_restore_restore_window_ms) AS histogram_parent_fx_session_restore_restore_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_session_restore_startup_init_session_ms) AS histogram_parent_fx_session_restore_startup_init_session_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_session_restore_startup_onload_initial_window_ms) AS histogram_parent_fx_session_restore_startup_onload_initial_window_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_tab_close_time_anim_ms) AS histogram_parent_fx_tab_close_time_anim_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_tab_switch_total_e10s_ms) AS histogram_parent_fx_tab_switch_total_e10s_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_tab_switch_update_ms) AS histogram_parent_fx_tab_switch_update_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_urlbar_selected_result_index) AS histogram_parent_fx_urlbar_selected_result_index,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_urlbar_selected_result_index_by_type) AS histogram_parent_fx_urlbar_selected_result_index_by_type,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_urlbar_selected_result_method) AS histogram_parent_fx_urlbar_selected_result_method,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_fx_urlbar_selected_result_type) AS histogram_parent_fx_urlbar_selected_result_type,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_gc_animation_ms) AS histogram_parent_gc_animation_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_gc_max_pause_ms) AS histogram_parent_gc_max_pause_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_gc_max_pause_ms_2) AS histogram_parent_gc_max_pause_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_geolocation_request_granted) AS histogram_parent_geolocation_request_granted,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ghost_windows) AS histogram_parent_ghost_windows,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_gpu_process_initialization_time_ms) AS histogram_parent_gpu_process_initialization_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_gpu_process_launch_time_ms_2) AS histogram_parent_gpu_process_launch_time_ms_2,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_http_channel_disposition) AS histogram_parent_http_channel_disposition,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_http_pageload_is_ssl) AS histogram_parent_http_pageload_is_ssl,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_http_transaction_is_ssl) AS histogram_parent_http_transaction_is_ssl,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_input_event_response_coalesced_ms) AS histogram_parent_input_event_response_coalesced_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ipc_read_main_thread_latency_ms) AS histogram_parent_ipc_read_main_thread_latency_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_distribution_among_content) AS histogram_parent_memory_distribution_among_content,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_heap_allocated) AS histogram_parent_memory_heap_allocated,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_resident_fast) AS histogram_parent_memory_resident_fast,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_total) AS histogram_parent_memory_total,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_unique) AS histogram_parent_memory_unique,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_vsize) AS histogram_parent_memory_vsize,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_memory_vsize_max_contiguous) AS histogram_parent_memory_vsize_max_contiguous,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_network_cache_metadata_first_read_time_ms) AS histogram_parent_network_cache_metadata_first_read_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_network_cache_v2_hit_time_ms) AS histogram_parent_network_cache_v2_hit_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_network_cache_v2_miss_time_ms) AS histogram_parent_network_cache_v2_miss_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_places_autocomplete_6_first_results_time_ms) AS histogram_parent_places_autocomplete_6_first_results_time_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_plugin_shutdown_ms) AS histogram_parent_plugin_shutdown_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_blocklist_num_sites) AS histogram_parent_pwmgr_blocklist_num_sites,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_form_autofill_result) AS histogram_parent_pwmgr_form_autofill_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_login_last_used_days) AS histogram_parent_pwmgr_login_last_used_days,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_login_page_safety) AS histogram_parent_pwmgr_login_page_safety,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_manage_opened) AS histogram_parent_pwmgr_manage_opened,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_manage_visibility_toggled) AS histogram_parent_pwmgr_manage_visibility_toggled,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_num_passwords_per_hostname) AS histogram_parent_pwmgr_num_passwords_per_hostname,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_num_saved_passwords) AS histogram_parent_pwmgr_num_saved_passwords,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_prompt_remember_action) AS histogram_parent_pwmgr_prompt_remember_action,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_prompt_update_action) AS histogram_parent_pwmgr_prompt_update_action,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_pwmgr_saving_enabled) AS histogram_parent_pwmgr_saving_enabled,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_sandbox_rejected_syscalls) AS histogram_parent_sandbox_rejected_syscalls,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_search_reset_result) AS histogram_parent_search_reset_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_search_service_init_ms) AS histogram_parent_search_service_init_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ssl_handshake_result) AS histogram_parent_ssl_handshake_result,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ssl_handshake_version) AS histogram_parent_ssl_handshake_version,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ssl_tls12_intolerance_reason_pre) AS histogram_parent_ssl_tls12_intolerance_reason_pre,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_ssl_tls13_intolerance_reason_pre) AS histogram_parent_ssl_tls13_intolerance_reason_pre,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_first_click_ms) AS histogram_parent_time_to_first_click_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_first_interaction_ms) AS histogram_parent_time_to_first_interaction_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_first_key_input_ms) AS histogram_parent_time_to_first_key_input_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_first_mouse_move_ms) AS histogram_parent_time_to_first_mouse_move_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_first_scroll_ms) AS histogram_parent_time_to_first_scroll_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_non_blank_paint_ms) AS histogram_parent_time_to_non_blank_paint_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_time_to_response_start_ms) AS histogram_parent_time_to_response_start_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_touch_enabled_device) AS histogram_parent_touch_enabled_device,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_tracking_protection_enabled) AS histogram_parent_tracking_protection_enabled,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_bits_result_complete) AS histogram_parent_update_bits_result_complete,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_bits_result_partial) AS histogram_parent_update_bits_result_partial,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_can_use_bits_notify) AS histogram_parent_update_can_use_bits_notify,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_download_code_complete) AS histogram_parent_update_download_code_complete,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_download_code_partial) AS histogram_parent_update_download_code_partial,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_state_code_complete_stage) AS histogram_parent_update_state_code_complete_stage,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_state_code_complete_startup) AS histogram_parent_update_state_code_complete_startup,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_state_code_partial_stage) AS histogram_parent_update_state_code_partial_stage,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_state_code_partial_startup) AS histogram_parent_update_state_code_partial_startup,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_status_error_code_complete_stage) AS histogram_parent_update_status_error_code_complete_stage,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_status_error_code_complete_startup) AS histogram_parent_update_status_error_code_complete_startup,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_status_error_code_partial_stage) AS histogram_parent_update_status_error_code_partial_stage,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_update_status_error_code_partial_startup) AS histogram_parent_update_status_error_code_partial_startup,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_uptake_remote_content_result_1) AS histogram_parent_uptake_remote_content_result_1,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_background_page_load_ms) AS histogram_parent_webext_background_page_load_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_browseraction_popup_open_ms) AS histogram_parent_webext_browseraction_popup_open_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_browseraction_popup_preload_result_count) AS histogram_parent_webext_browseraction_popup_preload_result_count,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_content_script_injection_ms) AS histogram_parent_webext_content_script_injection_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_extension_startup_ms) AS histogram_parent_webext_extension_startup_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_pageaction_popup_open_ms) AS histogram_parent_webext_pageaction_popup_open_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_storage_local_get_ms) AS histogram_parent_webext_storage_local_get_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webext_storage_local_set_ms) AS histogram_parent_webext_storage_local_set_ms,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webvr_time_spent_viewing_in_2d) AS histogram_parent_webvr_time_spent_viewing_in_2d,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webvr_time_spent_viewing_in_oculus) AS histogram_parent_webvr_time_spent_viewing_in_oculus,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webvr_time_spent_viewing_in_openvr) AS histogram_parent_webvr_time_spent_viewing_in_openvr,
    `moz-fx-data-shared-prod.udf.null_if_empty_list`(histogram_parent_webvr_users_view_in) AS histogram_parent_webvr_users_view_in
  )
FROM
