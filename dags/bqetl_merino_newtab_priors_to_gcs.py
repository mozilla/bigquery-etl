...
with DAG(
    ...
    wait_for_firefox_desktop_derived__newtab_content_items_daily__v1 = (
        ExternalTaskSensor(
            task_id="wait_for_firefox_desktop_derived__newtab_content_items_daily__v1",
            external_dag_id="bqetl_newtab",
            external_task_id="firefox_desktop_derived__newtab_content_items_daily__v1",
    ...
    telemetry_derived__newtab_merino_propensity__v1 = GKEPodOperator(
        task_id="telemetry_derived__newtab_merino_propensity__v1",
        arguments=[
            "python",
            "sql/moz-fx-data-shared-prod/telemetry_derived/newtab_merino_propensity_v1/query.py",
        ]
        + [
            "--project",
            "moz-fx-data-shared-prod",
