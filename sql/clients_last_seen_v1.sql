...
WITH current_sample AS (
  ...
  SELECT
    ...
    STRUCT( IF(last_date.seen_in_tier1_country > DATE_SUB(@submission_date, INTERVAL 28 DAY),
...
SELECT
  ...
  STRUCT( COALESCE([current_sample.last_date.seen_in_tier1_country,
