...
IF
  NOT EXISTS `moz-fx-data-shared-prod.mozillavpn_backend_cirrus_derived.event_monitoring_live_v1`
  OPTIONS
  ...
  FROM
    `moz-fx-data-shared-prod.mozillavpn_backend_cirrus_live.events_v1`
  CROSS JOIN
