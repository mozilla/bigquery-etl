...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_frontend.events_unnested`
AS
SELECT
  "subscription_platform_frontend" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_frontend.events` AS e
CROSS JOIN
