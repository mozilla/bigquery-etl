...
AS
  (
    SELECT
      ...
      from_msi,
      funnelcake,
      attribution.experiment AS experiment,
      attribution.variation AS variation,
      metadata.isp.name AS nm,
      metadata.isp.organization AS organization,
      ping_version,
      attribution.campaign AS campaign,
      attribution.content AS content,
      attribution.dlsource AS dlsource,
      attribution.dltoken AS dltoken,
      attribution.medium AS medium,
      attribution.source AS source,
      attribution.ua AS ua,
