...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_desktop_background_update.temp_fog_initial_state`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_desktop_background_update_stable.temp_fog_initial_state_v1`
