-- Query generated by: templates/unnested_list_and_map_view.sql.py main_summary_v4 main_summary --view-dataset=telemetry_raw
CREATE OR REPLACE VIEW
  `moz-fx-data-derived-datasets.telemetry_raw.main_summary` AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-derived-datasets.telemetry_raw.main_summary_v4`
