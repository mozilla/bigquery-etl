...
MERGE INTO
  `moz-fx-data-shared-prod.org_mozilla_firefox_beta_derived.gecko_trace_trace_events_v1` AS T
  USING (
    WITH RECURSIVE
...
-- Included by traces_v1 and trace_events_v1 scripts.
    ...
    new_trace_events AS (
      ...
      JOIN
        `moz-fx-data-shared-prod.org_mozilla_firefox_beta_derived.gecko_trace_events_v1` ev
