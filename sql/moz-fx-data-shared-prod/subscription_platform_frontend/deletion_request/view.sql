...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_frontend.deletion_request`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_frontend_stable.deletion_request_v1`
