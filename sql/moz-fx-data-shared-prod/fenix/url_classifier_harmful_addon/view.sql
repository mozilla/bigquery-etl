...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.fenix.url_classifier_harmful_addon`
AS
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_firefox.url_classifier_harmful_addon`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_firefox_beta.url_classifier_harmful_addon`
UNION ALL
SELECT
...
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_fenix_nightly.url_classifier_harmful_addon`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_fennec_aurora.url_classifier_harmful_addon`
