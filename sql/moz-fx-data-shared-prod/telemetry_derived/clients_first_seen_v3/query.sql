...
_current AS (
  ...
  SELECT
    ...
    unioned.architecture,
    unioned.app_build_id,
    unioned.app_name,
    unioned.locale,
    unioned.platform_version,
    unioned.vendor,
    unioned.app_version,
    unioned.xpcom_abi,
    unioned.document_id,
    unioned.distribution_id,
    unioned.partner_distribution_version,
    unioned.partner_distributor,
    unioned.partner_distributor_channel,
    unioned.partner_id,
    unioned.attribution_campaign,
    unioned.attribution_content,
    unioned.attribution_dltoken,
    unioned.attribution_dlsource,
    unioned.attribution_experiment,
    unioned.attribution_medium,
    unioned.attribution_source,
    unioned.attribution_ua,
    unioned.attribution_variation,
    unioned.engine_data_load_path,
    unioned.engine_data_name,
    unioned.engine_data_origin,
    unioned.engine_data_submission_url,
    unioned.apple_model_id,
    unioned.city,
    unioned.db_version,
    unioned.subdivision1,
    unioned.isp_name,
    unioned.normalized_channel,
    unioned.country,
    unioned.normalized_os,
    unioned.normalized_os_version,
    unioned.startup_profile_selection_reason,
    unioned.installation_first_seen_admin_user,
    unioned.installation_first_seen_default_path,
    unioned.installation_first_seen_failure_reason,
    unioned.installation_first_seen_from_msi,
    unioned.installation_first_seen_install_existed,
    unioned.installation_first_seen_installer_type,
    unioned.installation_first_seen_other_inst,
    unioned.installation_first_seen_other_msix_inst,
    unioned.installation_first_seen_profdir_existed,
    unioned.installation_first_seen_silent,
    unioned.installation_first_seen_version,
    unioned.os,
    unioned.os_version,
