-- query for org_mozilla_fenix_glam_beta__clients_scalar_aggregates_v1;
...
version_filtered_new AS (
  ...
  LEFT JOIN
    glam_etl.org_mozilla_fenix_glam_beta__latest_versions_v1
  USING
    (channel)
  WHERE
...
filtered_old AS (
  SELECT
    ...
    scalar_aggregates
  FROM
    glam_etl.org_mozilla_fenix_glam_beta__clients_scalar_aggregates_v1 AS scalar_aggs
  LEFT JOIN
    glam_etl.org_mozilla_fenix_glam_beta__latest_versions_v1
  USING
    (channel)
