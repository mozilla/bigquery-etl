...
with DAG(
    ...
    with TaskGroup(
        "bigeye__fenix_derived__terms_of_use_status__v1_external",
        parent_group=task_group_fenix,
    ) as bigeye__fenix_derived__terms_of_use_status__v1_external:
        ExternalTaskMarker(
            task_id="bqetl_analytics_aggregations__wait_for_bigeye__fenix_derived__terms_of_use_status__v1",
            external_dag_id="bqetl_analytics_aggregations",
            external_task_id="wait_for_bigeye__fenix_derived__terms_of_use_status__v1",
            execution_date="{{ (execution_date - macros.timedelta(seconds=6300)).isoformat() }}",
        )

        bigeye__fenix_derived__terms_of_use_status__v1_external.set_upstream(
            bigeye__fenix_derived__terms_of_use_status__v1
        )
    ...
    with TaskGroup(
        "bigeye__firefox_desktop_derived__terms_of_use_status__v1_external",
        parent_group=task_group_firefox_desktop,
    ) as bigeye__firefox_desktop_derived__terms_of_use_status__v1_external:
        ExternalTaskMarker(
            task_id="bqetl_analytics_aggregations__wait_for_bigeye__firefox_desktop_derived__terms_of_use_status__v1",
            external_dag_id="bqetl_analytics_aggregations",
            external_task_id="wait_for_bigeye__firefox_desktop_derived__terms_of_use_status__v1",
            execution_date="{{ (execution_date - macros.timedelta(seconds=6300)).isoformat() }}",
        )

        bigeye__firefox_desktop_derived__terms_of_use_status__v1_external.set_upstream(
            bigeye__firefox_desktop_derived__terms_of_use_status__v1
        )
    ...
    with TaskGroup(
        "bigeye__firefox_ios_derived__terms_of_use_status__v1_external",
        parent_group=task_group_firefox_ios,
    ) as bigeye__firefox_ios_derived__terms_of_use_status__v1_external:
        ExternalTaskMarker(
            task_id="bqetl_analytics_aggregations__wait_for_bigeye__firefox_ios_derived__terms_of_use_status__v1",
            external_dag_id="bqetl_analytics_aggregations",
            external_task_id="wait_for_bigeye__firefox_ios_derived__terms_of_use_status__v1",
            execution_date="{{ (execution_date - macros.timedelta(seconds=6300)).isoformat() }}",
        )

        bigeye__firefox_ios_derived__terms_of_use_status__v1_external.set_upstream(
            bigeye__firefox_ios_derived__terms_of_use_status__v1
        )
