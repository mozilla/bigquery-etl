...
IF
  (_current.user_id IS NOT NULL,
    ...
    udf.combine_adjacent_days_28_bits(_previous.days_seen_in_tier1_country_bits,
      _current.days_seen_in_tier1_country_bits) AS days_seen_in_tier1_country_bits,
    udf.coalesce_adjacent_days_28_bits(_previous.days_registered_bits,
      _current.days_registered_bits) AS days_registered_bits,
    udf.combine_adjacent_days_28_bits(_previous.days_seen_no_monitor_bits,
