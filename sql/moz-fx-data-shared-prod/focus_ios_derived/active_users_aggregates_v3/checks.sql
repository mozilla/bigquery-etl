...
SELECT
  IF(
    ...
    ERROR(
      CONCAT(
        "Daily users mismatch between the focus_ios live across all channels (`moz-fx-data-shared-prod.org_mozilla_ios_focus_live.baseline_v1`,) and active_users_aggregates (`{{ dataset_id }}.{{ table_name }}`) tables is greater than 10.",
        " Live table count: ",
