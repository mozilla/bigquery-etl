...
days_since_desktop_active (description = ""),
days_since_seen (description = ""),
days_since_active (description = ""),
days_since_created_profile (description = ""),
days_since_seen_session_start (description = ""),
days_since_seen_session_end (description = ""),
days_seen_bits (description = ""),
days_created_profile_bits (description = ""),
...
first_run_date (description = ""),
durations (description = ""),
days_seen_session_start_bits (description = ""),
days_seen_session_end_bits (description = ""),
...
app_build (description = ""),
app_channel (description = ""),
architecture (description = ""),
device_manufacturer (description = ""),
...
first_seen_date (description = ""),
is_new_profile (description = ""),
isp (description = "The name of the internet service provider associated with the client's IP address."),
days_active_bits (description = ""),
geo_subdivision (description = ""),
profile_group_id (description = "A UUID uniquely identifying the profile group, not shared with other telemetry data."),
install_source (description = ""),
days_desktop_active_bits (description = ""),
windows_build_number (description = ""),
browser_engagement_uri_count (description = ""),
browser_engagement_active_ticks (description = ""),
...
attribution_dltoken (description = ""),
attribution_dlsource (description = ""),
