...
IF
  NOT EXISTS `moz-fx-data-shared-prod.accounts_frontend_derived.event_monitoring_live_v1`
  OPTIONS
  ...
  FROM
    `moz-fx-data-shared-prod.accounts_frontend_live.accounts_events_v1`
  CROSS JOIN
