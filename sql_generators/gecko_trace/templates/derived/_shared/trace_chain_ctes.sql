-- Shared CTEs: raw span extraction, effective parent resolution,
-- per-event hashing, Merkle-chain signatures, and trace signature computation.
-- Included by traces and trace_events scripts.
raw_spans AS (
  SELECT
