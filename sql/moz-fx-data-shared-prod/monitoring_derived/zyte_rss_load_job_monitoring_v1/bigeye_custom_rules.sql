...
-- {'name': 'zyte_cache_failures_critical', 'alert_type': 'count', 'range': {'max': 1400}, 'collections': ['Home Newtab'], 'schedule': 'Default Schedule - 13:00 UTC'}
SELECT
...
-- {'name': 'rss_feed_items_failures_critical', 'alert_type': 'count', 'range': {'max': 1400}, 'collections': ['Home Newtab'], 'schedule': 'Default Schedule - 13:00 UTC'}
SELECT
