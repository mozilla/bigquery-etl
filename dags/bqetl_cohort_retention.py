...
with DAG(
    ...
    glean_telemetry_derived__cohort_weekly_active_clients_staging__v1 = (
        bigquery_etl_query(
            task_id="glean_telemetry_derived__cohort_weekly_active_clients_staging__v1",
    ...
    glean_telemetry_derived__cohort_weekly_statistics__v1 = bigquery_etl_query(
        task_id="glean_telemetry_derived__cohort_weekly_statistics__v1",
    ...
    glean_telemetry_derived__cohort_weekly_statistics__v1.set_upstream(
        glean_telemetry_derived__cohort_weekly_active_clients__v1
    )

    glean_telemetry_derived__cohort_weekly_statistics__v1.set_upstream(
        glean_telemetry_derived__cohort_weekly_cfs_staging__v1
    )
