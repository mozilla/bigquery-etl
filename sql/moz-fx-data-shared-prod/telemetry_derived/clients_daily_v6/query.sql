...
SELECT
  * EXCEPT (map_sum_aggregates),
  ...
  case when mozfun.norm.truncate_version(app_version, "major") <= 108 then map_sum_aggregates[OFFSET(38)].map 
  when mozfun.norm.truncate_version(app_version, "major") <= 108 then map_sum_aggregates[OFFSET(110)].map
  else null AS search_with_ads,
  case when mozfun.norm.truncate_version(app_version, "major") <= 108 then map_sum_aggregates[OFFSET(39)].map
  when mozfun.norm.truncate_version(app_version, "major") > 108  then map_sum_aggregates[OFFSET(109)].map
