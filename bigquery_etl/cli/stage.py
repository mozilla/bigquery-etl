...
from ..metadata.parse_metadata import DatasetMetadata
    ...
    for dep_file in view_dependency_files:
        ...
        if dep_file.name == VIEW_FILE:
            ...
            for dependency in view.table_references:
                ...
                # if so, skip creating schema and dependencies unless a local file exists
                dataset_metadata_path = (
                    Path(sql_dir) / project / dataset / "dataset_metadata.yaml"
                )
                is_syndicated = False
                if dataset_metadata_path.exists():
                    try:
                        ...
                        is_syndicated = dataset_metadata.dataset_base_acl == "syndicate"
                    except Exception:
                        pass
