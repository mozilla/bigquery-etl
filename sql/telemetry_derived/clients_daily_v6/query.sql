...
SELECT
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_accept_languages) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_app_locales) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_available_locales) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_requested_locales) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_system_locales) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      STRUCT(udf_null_if_empty_list(environment_settings_intl_regional_prefs_locales) AS list)
      ORDER BY
        `timestamp`
    )
  ...
  udf_json_mode_last(
    ARRAY_AGG(
      udf_geo_struct(country, city, geo_subdivision1, geo_subdivision2)
      ORDER BY
        `timestamp`
    )
  ).*,
