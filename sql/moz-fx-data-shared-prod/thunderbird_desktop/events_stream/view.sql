  ...
  * EXCEPT (event_id),
  STRUCT(
    STRUCT(
      ...
      LAX_BOOL(event_extra.is_encrypted) AS `is_encrypted`,
      ...
      LAX_BOOL(event_extra.is_signed) AS `is_signed`,
    ...
    STRUCT(
      ...
      JSON_VALUE(event_extra.error_category) AS `error_category`,
      ...
      JSON_VALUE(event_extra.importer) AS `importer`,
      ...
      JSON_VALUE(event_extra.issuer) AS `issuer`,
      ...
      JSON_VALUE(event_extra.notification_id) AS `notification_id`,
      ...
      JSON_VALUE(event_extra.port) AS `port`,
      ...
      JSON_VALUE(event_extra.types) AS `types`,
      JSON_VALUE(event_extra.typeWasPassword) AS `typeWasPassword`,
      JSON_VALUE(event_extra.ui) AS `ui`,
