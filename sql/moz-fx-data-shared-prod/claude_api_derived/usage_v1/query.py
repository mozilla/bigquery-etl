...
class BigQueryAPI:
    ...
    def load_usage_data(
        ...
        job = client.load_table_from_json(records, partitioned_table, job_config=job_config)
        job.result()
    ...
    def get_usage_for_date(self, date: datetime) -> list[dict]:
        ...
        while True:
            ...
            try:
                ...
                self.logger.critical("Failed while fetching usage data from Anthropic API")
                sys.exit(1)
