CREATE OR REPLACE FUNCTION
  norm.windows_version_info( os STRING,
    os_version STRING,
...
ASSERT
  .equals('Windows_95',
    norm.windows_version_info('Windows_95',
      NULL,
      NULL)),
ASSERT
  .equals('Windows_98',
    norm.windows_version_info('Windows_98',
      NULL,
      NULL)),
ASSERT
  .equals('Windows NT 4.0',
    norm.windows_version_info('Windows_NT',
      4.0,
      NULL)),
ASSERT
  .equals('Windows XP',
...
ASSERT
  .equals(NULL,
    norm.windows_version_info('Darwin',
      '11.4.2',
      NULL)),
ASSERT
  .equals(NULL,
