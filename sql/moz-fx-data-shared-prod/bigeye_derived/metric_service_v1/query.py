...
API_URL = (
    "https://app.bigeye.com/api/v1/metrics/info?muted=THREE_LEGGED_BOOLEAN_UNSPECIFIED"
    "&sortField=METRIC_SORT_FIELD_UNSPECIFIED"
...
def main() -> None:
    ...
    parser.add_argument("--table", default="metric_service_v1")
