...
IF
  NOT EXISTS `moz-fx-data-shared-prod.net_thunderbird_android_derived.event_monitoring_live_v1`
  PARTITION BY
  ...
  FROM
    (
      SELECT
        ...
        ping_info
      FROM
        `moz-fx-data-shared-prod.net_thunderbird_android_live.events_v1`
    )
  CROSS JOIN
