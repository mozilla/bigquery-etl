...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_backend.events_unnested`
AS
SELECT
  "subscription_platform_backend" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend.events` AS e
CROSS JOIN
