...
with DAG(
    ...
    wait_for_checks__fail_ltv_derived__ios_state_values__v1 = ExternalTaskSensor(
        task_id="wait_for_checks__fail_ltv_derived__ios_state_values__v1",
        external_dag_id="private_bqetl_ltv",
        external_task_id="checks__fail_ltv_derived__ios_state_values__v1",
    ...
    wait_for_checks__fail_revenue_derived__mobile_rpcs__v1 = ExternalTaskSensor(
        task_id="wait_for_checks__fail_revenue_derived__mobile_rpcs__v1",
        external_dag_id="private_bqetl_revenue",
        external_task_id="checks__fail_revenue_derived__mobile_rpcs__v1",
        execution_delta=datetime.timedelta(seconds=27000),
        check_existence=True,
        mode="reschedule",
        poke_interval=datetime.timedelta(minutes=5),
        allowed_states=ALLOWED_STATES,
    ...
    wait_for_firefox_ios_derived__client_ltv__v1 = ExternalTaskSensor(
        task_id="wait_for_firefox_ios_derived__client_ltv__v1",
        external_dag_id="bqetl_org_mozilla_firefox_derived",
        external_task_id="firefox_ios_derived__client_ltv__v1",
