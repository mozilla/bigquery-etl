-- Query generated by: templates/unnest_parquet_view.sql.py first_shutdown_summary_v4 telemetry_raw.first_shutdown_summary_v4
...
FROM
  `moz-fx-data-derived-datasets.telemetry_raw.first_shutdown_summary_v4`
