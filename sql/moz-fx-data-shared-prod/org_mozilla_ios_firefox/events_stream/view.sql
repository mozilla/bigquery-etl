  ...
  * EXCEPT (event_id),
  STRUCT(
    STRUCT(
      ...
      LAX_BOOL(event_extra.has_summarizer) AS `has_summarizer`,
    ...
    STRUCT(
      ...
      JSON_VALUE(event_extra.fifa_code) AS `fifa_code`,
      ...
      JSON_VALUE(event_extra.match) AS `match`,
      ...
      JSON_VALUE(event_extra.summary_language) AS `summary_language`,
