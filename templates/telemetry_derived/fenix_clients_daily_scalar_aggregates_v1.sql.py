...
def generate_sql(
    ...
    date = "date_sub(current_date, interval 2 day)" if no_parameterize else "@submission_date"
    return f"""\
        -- Query generated by:
        -- templates/fenix_clients_daily_scalar_aggregates.sql.py --agg-type {agg_type}
        WITH filtered AS (
        SELECT
            *,
...
def get_scalar_probes(scalar_type: str) -> Dict[str, List[str]]:
