...
1. Copy and paste the new fields in `schema.yaml` to the schemas for `clients_daily_joined_v1`, `clients_last_seen_v1`, `clients_last_seen_joined_v1`  and `clients_first_seen_v1`
