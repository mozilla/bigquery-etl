...
IF
  NOT EXISTS `moz-fx-data-shared-prod.org_mozilla_social_nightly_derived.event_monitoring_live_v1`
  PARTITION BY
  ...
  FROM
    (
      SELECT
        ...
        ping_info
      FROM
        `moz-fx-data-shared-prod.org_mozilla_social_nightly_live.events_v1`
    )
  CROSS JOIN
