...
SELECT
  assert_equals(DATE '2019-11-04', udf_parse_iso8601_date('2019-11-04')),
  assert_equals(DATE '2019-11-04', udf_parse_iso8601_date('2019-11-04T21:15:00+00:00')),
  assert_equals(DATE '2019-11-04', udf_parse_iso8601_date('20191104T211500Z')),
  assert_equals(DATE '0100-01-01', udf_parse_iso8601_date('100-1-1')),
  assert_null(udf_parse_iso8601_date('2000/01/01'))
