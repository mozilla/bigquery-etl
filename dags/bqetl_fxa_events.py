...
with DAG(
    ...
    firefox_accounts_derived__fxa_flows__v1 = bigquery_etl_query(
        task_id="firefox_accounts_derived__fxa_flows__v1",
        destination_table="fxa_flows_v1",
        dataset_id="firefox_accounts_derived",
        project_id="moz-fx-data-shared-prod",
    ...
    firefox_accounts_derived__fxa_flows__v1.set_upstream(
        firefox_accounts_derived__fxa_auth_events__v1
    )
