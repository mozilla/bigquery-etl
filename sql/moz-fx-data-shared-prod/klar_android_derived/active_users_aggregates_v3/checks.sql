...
SELECT
  IF(
    ...
    ERROR(
      CONCAT(
        "Daily users mismatch between the klar_android live across all channels (`moz-fx-data-shared-prod.org_mozilla_klar_live.baseline_v1`,) and active_users_aggregates (`{{ dataset_id }}.{{ table_name }}`) tables is greater than 10.",
        " Live table count: ",
