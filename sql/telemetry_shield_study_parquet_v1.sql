...
--
-- Query generated by: templates/unnest_parquet_view.sql.py telemetry_shield_study_parquet_v1 telemetry_raw.telemetry_shield_study_parquet_v1
CREATE OR REPLACE VIEW
  `moz-fx-data-derived-datasets.telemetry.telemetry_shield_study_parquet_v1` AS
SELECT
...
FROM
  `moz-fx-data-derived-datasets.telemetry_raw.telemetry_shield_study_parquet_v1`
