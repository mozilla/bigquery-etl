...
with DAG(
    ...
    firefoxdotcom_derived__firefox_whatsnew_summary__v2 = bigquery_etl_query(
        task_id="firefoxdotcom_derived__firefox_whatsnew_summary__v2",
    ...
    firefoxdotcom_derived__www_site_page_metrics__v1 = bigquery_etl_query(
        task_id="firefoxdotcom_derived__www_site_page_metrics__v1",
