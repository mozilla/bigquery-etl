...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.fenix.prefs_file_invalid`
AS
SELECT
  ...
  STRUCT(
    ...
    STRUCT(metrics.text2.preferences_prefs_file_that_failed_to_parse) AS `text2`
  ) AS `metrics`,
  normalized_app_name,
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_firefox.prefs_file_invalid`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_firefox_beta.prefs_file_invalid`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_fenix.prefs_file_invalid`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_fenix_nightly.prefs_file_invalid`
UNION ALL
SELECT
  ...
  is_bot_generated
FROM
  `moz-fx-data-shared-prod.org_mozilla_fennec_aurora.prefs_file_invalid`
