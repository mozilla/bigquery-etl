SELECT
  ...
  SUM(SAFE_CAST(JSON_EXTRACT_SCALAR(payload.histograms.http_pageload_is_ssl, '$.values.0') AS INT64)) AS non_ssl_loads,
  SUM(SAFE_CAST(JSON_EXTRACT_SCALAR(payload.histograms.http_pageload_is_ssl, '$.values.1') AS INT64)) AS ssl_loads,
