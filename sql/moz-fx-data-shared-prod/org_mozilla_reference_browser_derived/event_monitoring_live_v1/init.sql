...
IF
  NOT EXISTS `moz-fx-data-shared-prod.org_mozilla_reference_browser_derived.event_monitoring_live_v1`
  OPTIONS
  ...
  FROM
    `moz-fx-data-shared-prod.org_mozilla_reference_browser_live.events_v1`
  CROSS JOIN
