CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.app_store.firefox_app_store_territory_web_referrer_report`
AS
SELECT
  ...
  * REPLACE (TIMESTAMP(DATETIME(`date`, "America/Los_Angeles")) AS `date`),
  `date` AS date_pst,
FROM
  `moz-fx-data-shared-prod.app_store_syndicate.firefox_app_store_territory_web_referrer_report_v1`
