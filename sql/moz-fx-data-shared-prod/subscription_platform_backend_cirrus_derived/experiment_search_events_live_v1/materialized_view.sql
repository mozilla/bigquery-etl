...
CREATE MATERIALIZED VIEW IF NOT EXISTS
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus_derived.experiment_search_events_live_v1`
PARTITION BY
  DATE(partition_date)
OPTIONS
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus_live.enrollment_v1`
LEFT JOIN
