-- view for org_mozilla_fenix_glam_release__view_clients_daily_scalar_aggregates_v1;
...
FROM
  `moz-fx-data-shared-prod.glam_etl.org_mozilla_fenix_glam_release__clients_daily_scalar_aggregates*`
