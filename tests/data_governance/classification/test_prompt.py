...
class TestBuildClassificationPrompt:
    def test_column_identity_and_taxonomy(self):
        ...
        # The response shape lives only in Vertex's response schema. Google warns
        # that duplicating it in the prompt can reduce output quality.
        assert "Respond with a JSON object" not in prompt
        assert '"secondary_labels"' not in prompt
