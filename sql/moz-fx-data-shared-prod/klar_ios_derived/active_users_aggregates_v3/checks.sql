...
SELECT
  IF(
    ...
    ERROR(
      CONCAT(
        "DAU mismatch between the klar_ios live across all channels (`moz-fx-data-shared-prod.org_mozilla_ios_klar_live.baseline_v1`,) and active_users_aggregates (`klar_ios_derived.active_users_aggregates_v3`) tables is greater than 10.",
        " Live table count: ",
