...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.org_mozilla_ios_tiktok_reporter_tiktok_reportershare.health`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.org_mozilla_ios_tiktok_reporter_tiktok_reportershare_stable.health_v1`
