...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.focus_ios.usage_reporting_active_users_aggregates`
AS
SELECT
  *,
...
FROM
  `moz-fx-data-shared-prod.focus_ios_derived.usage_reporting_active_users_aggregates_v1`
