SELECT
  ...
  MAX(CASE WHEN name = 'surface_not_now_clicked' THEN 1 ELSE 0 END) is_surface_not_now_clicked,
  MAX(CASE WHEN name = 'surface_onboarding_displayed' THEN 1 ELSE 0 END) is_surface_onboarding_displayed,
  MAX(CASE WHEN name = 'surface_opt_in_clicked' THEN 1 ELSE 0 END) is_surface_opt_in_clicked,
  ...
  MAX(CASE WHEN name = 'surface_show_quality_explainer_url_clicked' THEN 1 ELSE 0 END) is_surface_show_quality_explainer_url_clicked,
