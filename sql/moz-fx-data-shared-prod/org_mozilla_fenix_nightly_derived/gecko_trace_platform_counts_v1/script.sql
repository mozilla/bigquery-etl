...
MERGE INTO
  `moz-fx-data-shared-prod.org_mozilla_fenix_nightly_derived.gecko_trace_platform_counts_v1` AS T
  USING (
    WITH RECURSIVE
...
-- Included by traces_v1 and trace_events_v1 scripts.
    ...
    platform_counts AS (
      ...
      JOIN
        `moz-fx-data-shared-prod.org_mozilla_fenix_nightly_derived.gecko_trace_traces_v1` tr
