-- view for org_mozilla_firefox_beta__view_clients_daily_histogram_aggregates_v1;
...
FROM
  `moz-fx-data-shared-prod.glam_etl.org_mozilla_firefox_beta__clients_daily_histogram_aggregates*`
