...
IF
  NOT EXISTS `moz-fx-data-shared-prod.net_thunderbird_android_daily_derived.event_monitoring_live_v1`
  PARTITION BY
  ...
  WITH base_events_v1 AS (
    ...
    FROM
      `moz-fx-data-shared-prod.net_thunderbird_android_daily_live.events_v1`
    CROSS JOIN
