...
class TestMetadata:
    ...
    def test_validate_metadata_duplicate_param(self, runner, capfd):
        """Validation should fail when there duplicate query parameters."""
        metadata = {
            "friendly_name": "Test",
            "scheduling": {
    ...
    def test_validate_metadata_incompatible_partition_param(self, runner, capfd):
        ...
        captured = capfd.readouterr()
        assert (
            "has partitioning parameter but is not a partitioned table" in captured.out
        )

    def test_validate_metadata_partitioned_with_no_partition_param(self, runner, capfd):
        ...
        captured = capfd.readouterr()
        assert (
            "partitioned table but partitioning parameter is set to null"
            in captured.out
        )
