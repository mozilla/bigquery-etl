...
join_sap_serp_cte AS (
  ...
  LEFT JOIN
    sap_final_cte
    ON sap_final_cte.client_id IS NOT DISTINCT FROM serp_final_cte.client_id
    AND sap_final_cte.submission_date IS NOT DISTINCT FROM serp_final_cte.submission_date
