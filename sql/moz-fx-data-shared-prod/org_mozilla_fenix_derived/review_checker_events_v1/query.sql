SELECT
  ...
  MAX(CASE WHEN name = 'surface_expand_settings' THEN 1 ELSE 0 END) is_surface_settings_expand_clicked,
  ...
  MAX(CASE WHEN name = 'surface_opt_in_accepted' THEN 1 ELSE 0 END) is_surface_opt_in_clicked,
