...
Built from bigquery-etl repo, [`dags/bqetl_org_mozilla_focus_derived.py`](https://github.com/mozilla/bigquery-etl/blob/generated-sql/dags/bqetl_org_mozilla_focus_derived.py)
