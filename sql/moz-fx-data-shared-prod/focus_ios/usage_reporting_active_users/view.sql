...
FROM
  `moz-fx-data-shared-prod.focus_ios.usage_reporting_clients_last_seen` AS last_seen
LEFT JOIN
  `moz-fx-data-shared-prod.focus_ios.usage_reporting_clients_daily` AS daily
