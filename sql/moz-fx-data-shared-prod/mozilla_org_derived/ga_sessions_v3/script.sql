...
MERGE INTO
  ...
  USING (
    ...
    attr_info_from_event_params_in_session_staging AS (
      SELECT
        ...
        (
          ...
          LIMIT
            1
        ).string_value AS medium_from_event_params,
        (
          SELECT
            `value`
          FROM
    ...
    attr_info_by_session AS (
      SELECT
        ga_client_id,
        ga_session_id,
        MAX(session_engaged_indicator) AS engaged_session,
        DATETIME(
        ...
        ARRAY_AGG(campaign_from_event_params IGNORE NULLS ORDER BY event_timestamp ASC)[
          SAFE_OFFSET(0)
        ] AS first_campaign_from_event_params,
        ARRAY_AGG(
          DISTINCT source_from_event_params IGNORE NULLS
        ) AS distinct_sources_from_event_params,
        ARRAY_AGG(source_from_event_params IGNORE NULLS ORDER BY event_timestamp ASC)[
          SAFE_OFFSET(0)
        ] AS first_source_from_event_params,
        ARRAY_AGG(
          DISTINCT medium_from_event_params IGNORE NULLS
        ) AS distinct_mediums_from_event_params,
        ARRAY_AGG(medium_from_event_params IGNORE NULLS ORDER BY event_timestamp ASC)[
          SAFE_OFFSET(0)
        ] AS first_medium_from_event_params,
        ARRAY_AGG(
          DISTINCT content_from_event_params IGNORE NULLS
        ) AS distinct_contents_from_event_params,
    ...
    SELECT
      ...
      sess_strt.manual_medium,
      sess_strt.manual_term,
      sess_strt.manual_content,
      clicks.gclid,
      clicks.gclid_array,
...
THEN
  ...
  VALUES
    (
      ...
      S.first_source_from_event_params,
      S.distinct_sources_from_event_params,
      S.first_medium_from_event_params,
      S.distinct_mediums_from_event_params,
      S.first_content_from_event_params,
      S.distinct_contents_from_event_params,
      S.manual_campaign_id,
      S.manual_campaign_name,
      S.manual_source,
      S.manual_medium,
      S.manual_term,
      S.manual_content,
...
THEN
  UPDATE
    ...
    T.session_start_timestamp = S.session_start_timestamp,
    ...
    T.first_source_from_event_params = S.first_source_from_event_params,
    T.distinct_sources_from_event_params = S.distinct_sources_from_event_params,
    T.first_medium_from_event_params = S.first_medium_from_event_params,
    T.distinct_mediums_from_event_params = S.distinct_mediums_from_event_params,
    T.first_content_from_event_params = S.first_content_from_event_params,
    T.distinct_contents_from_event_params = S.distinct_contents_from_event_params,
    T.manual_campaign_id = S.manual_campaign_id,
    T.manual_campaign_name = S.manual_campaign_name,
    T.manual_source = S.manual_source,
    T.manual_medium = S.manual_medium,
    T.manual_term = S.manual_term,
    T.manual_content = S.manual_content,
    T.gclid = S.gclid,
    ...
    T.engaged_session = S.engaged_session
