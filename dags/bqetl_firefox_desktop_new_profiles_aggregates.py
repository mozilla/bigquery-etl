...
Built from bigquery-etl repo, [`dags/bqetl_firefox_desktop_new_profiles_aggregates.py`](https://github.com/mozilla/bigquery-etl/blob/generated-sql/dags/bqetl_firefox_desktop_new_profiles_aggregates.py)
...
default_args = {
    ...
    "start_date": datetime.datetime(2025, 6, 2, 0, 0),
    "end_date": None,
...
with DAG(
    ...
    firefox_desktop_derived__new_profiles_aggregates__v1 = bigquery_etl_query(
        task_id="firefox_desktop_derived__new_profiles_aggregates__v1",
        destination_table="new_profiles_aggregates_v1",
    ...
    firefox_desktop_derived__new_profiles_aggregates__v1.set_upstream(
