CREATE OR REPLACE FUNCTION
  udf.int_to_365_bits(value INT64) AS (
...
SELECT
  ...
  assert_equals(udf.one_as_365_bits() << 63, udf_int_to_365_bits(1 << 63)),
  assert_equals(udf.one_as_365_bits() << 22, udf_int_to_365_bits(1 << 22)),
  assert_equals(b'\x01\x00', ltrim(udf.int_to_365_bits(1 << 8), b'\x00')),
  assert_equals(udf.one_as_365_bits() << 5, udf_int_to_365_bits(32)),
