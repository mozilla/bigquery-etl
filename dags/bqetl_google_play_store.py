...
google_play_store_derived__vitals_anr_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood = Secret(
    deploy_type="env",
    deploy_target="GOOGLE_PLAY_STORE_SRVC_ACCT_INFO",
    secret="airflow-gke-secrets",
    key="bqetl_google_play_store_developer_reporting_api_data_boxwood",
)
google_play_store_derived__vitals_crash_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood = Secret(
    deploy_type="env",
    deploy_target="GOOGLE_PLAY_STORE_SRVC_ACCT_INFO",
    secret="airflow-gke-secrets",
    key="bqetl_google_play_store_developer_reporting_api_data_boxwood",
...
google_play_store_derived__vitals_lmk_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood = Secret(
    deploy_type="env",
    deploy_target="GOOGLE_PLAY_STORE_SRVC_ACCT_INFO",
    secret="airflow-gke-secrets",
    key="bqetl_google_play_store_developer_reporting_api_data_boxwood",
...
with DAG(
    ...
    google_play_store_derived__vitals_anr_rate__v1 = GKEPodOperator(
        task_id="google_play_store_derived__vitals_anr_rate__v1",
        arguments=[
            "python",
            "sql/moz-fx-data-shared-prod/google_play_store_derived/vitals_anr_rate_v1/query.py",
        ]
        ...
        email=["kik@mozilla.com", "telemetry-alerts@mozilla.com"],
        secrets=[
            google_play_store_derived__vitals_anr_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood,
        ],
    )

    google_play_store_derived__vitals_crash_rate__v1 = GKEPodOperator(
        task_id="google_play_store_derived__vitals_crash_rate__v1",
        arguments=[
            "python",
            "sql/moz-fx-data-shared-prod/google_play_store_derived/vitals_crash_rate_v1/query.py",
        ]
        + ["--date={{macros.ds_add(ds, -1)}}"],
        image="us-docker.pkg.dev/moz-fx-data-artifacts-prod/bigquery-etl/bigquery-etl:latest",
        owner="kik@mozilla.com",
        email=["kik@mozilla.com", "telemetry-alerts@mozilla.com"],
        secrets=[
            google_play_store_derived__vitals_crash_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood,
        ],
    )
    ...
    google_play_store_derived__vitals_lmk_rate__v1 = GKEPodOperator(
        task_id="google_play_store_derived__vitals_lmk_rate__v1",
        arguments=[
            "python",
            "sql/moz-fx-data-shared-prod/google_play_store_derived/vitals_lmk_rate_v1/query.py",
        ]
        + ["--date={{macros.ds_add(ds, -1)}}"],
        image="us-docker.pkg.dev/moz-fx-data-artifacts-prod/bigquery-etl/bigquery-etl:latest",
        owner="kik@mozilla.com",
        email=["kik@mozilla.com", "telemetry-alerts@mozilla.com"],
        secrets=[
            google_play_store_derived__vitals_lmk_rate__v1_bqetl_google_play_store_developer_reporting_api_data_boxwood,
        ],
    )
