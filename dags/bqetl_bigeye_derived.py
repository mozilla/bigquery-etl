...
bigeye_derived__group_service__v1_bqetl_bigeye_api_key = Secret(
    deploy_type="env",
    deploy_target="BIGEYE_API_KEY",
    secret="airflow-gke-secrets",
    key="bqetl_bigeye_api_key",
...
bigeye_derived__metric_service__v1_bqetl_bigeye_api_key = Secret(
    deploy_type="env",
    deploy_target="BIGEYE_API_KEY",
    secret="airflow-gke-secrets",
    key="bqetl_bigeye_api_key",
...
with DAG(
    ...
    bigeye_derived__group_service__v1 = GKEPodOperator(
        task_id="bigeye_derived__group_service__v1",
        arguments=[
            "python",
    ...
    bigeye_derived__metric_service__v1 = GKEPodOperator(
        task_id="bigeye_derived__metric_service__v1",
        arguments=[
            "python",
