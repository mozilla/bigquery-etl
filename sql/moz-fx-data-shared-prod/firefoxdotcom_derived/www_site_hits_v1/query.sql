...
final_staging AS (
  SELECT
    ...
    REGEXP_REPLACE(all_events.page_location, '^https://www.firefox.com', '') AS page_path,
    ...
    all_events.country,
    all_events.traffic_source_name,
    all_events.traffic_source_medium,
    all_events.traffic_source_source,
    all_events.manual_campaign_id,
    all_events.manual_term,
    all_events.source,
    all_events.medium,
    all_events.campaign,
...
SELECT
  ...
  final.country,
  final.traffic_source_name,
  final.traffic_source_medium,
  final.traffic_source_source,
  final.manual_campaign_id,
  final.manual_term,
  final.source,
  final.medium,
  final.campaign,
