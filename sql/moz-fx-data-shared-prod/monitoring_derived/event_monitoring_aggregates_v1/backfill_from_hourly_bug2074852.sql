-- Copy of the generated query.sql with firefox_desktop read from the hourly staging
-- table populated by backfill_desktop_hourly.sql.
WITH firefox_desktop_aggregated AS (
  -- Hourly results from backfill_desktop_hourly.sql instead of event_monitoring_live_v1
  SELECT
    submission_date,
    window_start,
    window_end,
    ...
    total_events,
  FROM
    `moz-fx-data-shared-prod.tmp.event_monitoring_desktop_hourly`
  WHERE
...
base_org_mozilla_firefox_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_org_mozilla_firefox_beta_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_org_mozilla_fenix_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_org_mozilla_ios_firefox_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
  ...
  FROM
    (
      ...
      SELECT
        *
      FROM
        base_org_mozilla_ios_firefox_onboarding_v1
    )
  GROUP BY
    submission_date,
    window_start,
...
base_org_mozilla_ios_firefoxbeta_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
  ...
  FROM
    (
      ...
      SELECT
        *
      FROM
        base_org_mozilla_ios_firefoxbeta_onboarding_v1
    )
  GROUP BY
    submission_date,
    window_start,
...
base_org_mozilla_ios_fennec_onboarding_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
  ...
  FROM
    (
      ...
      SELECT
        *
      FROM
        base_org_mozilla_ios_fennec_onboarding_v1
    )
  GROUP BY
    submission_date,
    window_start,
...
base_thunderbird_crashreporter_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
thunderbird_crashreporter_aggregated AS (
  SELECT
    submission_date,
    window_start,
    window_end,
    ...
    SUM(total_events) AS total_events,
  FROM
    (SELECT * FROM base_thunderbird_crashreporter_events_v1)
  GROUP BY
    submission_date,
    window_start,
    window_end,
...
base_subscription_platform_frontend_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
subscription_platform_frontend_aggregated AS (
  SELECT
    submission_date,
    window_start,
    window_end,
    ...
    SUM(total_events) AS total_events,
  FROM
    (SELECT * FROM base_subscription_platform_frontend_events_v1)
  GROUP BY
    submission_date,
    window_start,
    window_end,
...
base_subscription_platform_backend_cirrus_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
subscription_platform_backend_cirrus_aggregated AS (
  SELECT
    submission_date,
    window_start,
    window_end,
    ...
    SUM(total_events) AS total_events,
  FROM
    (SELECT * FROM base_subscription_platform_backend_cirrus_events_v1)
  GROUP BY
    submission_date,
    window_start,
    window_end,
...
mdn_mcp_aggregated AS (
  SELECT
    ...
    SUM(total_events) AS total_events,
  FROM
    (SELECT * FROM base_mdn_mcp_events_v1)
  GROUP BY
    submission_date,
    window_start,
    window_end,
...
base_moz_backstage_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
moz_backstage_aggregated AS (
  SELECT
    ...
    SUM(total_events) AS total_events,
  FROM
    (SELECT * FROM base_moz_backstage_events_v1)
  GROUP BY
    submission_date,
    window_start,
    window_end,
...
base_firefox_enterprise_desktop_enterprise_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_newtab_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_nimbus_targeting_context_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_post_profile_restore_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_profile_restore_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_profiles_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_prototype_no_code_events_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
base_firefox_enterprise_desktop_sync_v1 AS (
  SELECT
    DATE(@submission_date) AS submission_date,
    TIMESTAMP_TRUNC(submission_timestamp, HOUR) AS window_start,
    TIMESTAMP_ADD(TIMESTAMP_TRUNC(submission_timestamp, HOUR), INTERVAL 1 HOUR) AS window_end,
...
firefox_enterprise_desktop_aggregated AS (
  SELECT
    submission_date,
    window_start,
    window_end,
  ...
  FROM
    (
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_enterprise_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_events_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_newtab_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_nimbus_targeting_context_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_post_profile_restore_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_profile_restore_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_profiles_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_prototype_no_code_events_v1
      UNION ALL
      SELECT
        *
      FROM
        base_firefox_enterprise_desktop_sync_v1
    )
  GROUP BY
    submission_date,
    window_start,
...
SELECT
  *
FROM
  thunderbird_crashreporter_aggregated
UNION ALL
SELECT
  *
FROM
...
SELECT
  *
FROM
  subscription_platform_frontend_aggregated
UNION ALL
SELECT
  *
FROM
...
SELECT
  *
FROM
  subscription_platform_backend_cirrus_aggregated
UNION ALL
SELECT
  *
FROM
...
SELECT
  *
FROM
  moz_backstage_aggregated
UNION ALL
SELECT
  *
FROM
  firefox_enterprise_desktop_aggregated
