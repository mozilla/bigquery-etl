...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.quick_suggest_deletion_request`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_enterprise_desktop_stable.quick_suggest_deletion_request_v1`
