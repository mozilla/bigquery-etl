...
IF
  NOT EXISTS `moz-fx-data-shared-prod.net_thunderbird_android_beta_derived.event_monitoring_live_v1`
  PARTITION BY
  ...
  FROM
    (
      ...
      FROM
        `moz-fx-data-shared-prod.net_thunderbird_android_beta_live.events_v1`
    )
  CROSS JOIN
