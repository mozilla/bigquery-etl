...
SKIP = {
    ...
    *glob.glob(
    ...
    "sql/moz-fx-data-shared-prod/contextual_services_derived/request_payload_suggest_v1/query.sql",
    "sql/moz-fx-data-shared-prod/contextual_services_derived/request_payload_tiles_v1/query.sql",
    *glob.glob(
