...
AS (
    ...
    CONCAT(
      CASE
          WHEN (days_since_first_seen < max_days) THEN days_since_first_seen
          ELSE max_days END,
      '_',
      ...
      CASE WHEN days_since_active >= death_time THEN '00'
      WHEN pattern < (lookback * 1.0 / 3.0) THEN '1'
      WHEN pattern BETWEEN (lookback * 1.0 / 3.0) AND (lookback * 2.0 / 3.0) THEN '2'
      WHEN pattern > (lookback * 2.0 / 3.0) THEN '3'
      ELSE '0' END,
      '_',
