...
IF
  NOT EXISTS `moz-fx-data-shared-prod.org_mozilla_fennec_aurora_derived.event_monitoring_live_v1`
  PARTITION BY
  ...
  FROM
    (
      ...
      FROM
        `moz-fx-data-shared-prod.org_mozilla_fennec_aurora_live.home_v1`
      UNION ALL
      SELECT
        submission_timestamp,
        events,
