...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus.enrollment_status`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus_stable.enrollment_status_v1`
