...
cloudflare_derived__os_usage__v1_bqetl_cloudflare_os_market_share__cloudflare_auth_token = Secret(
    deploy_type="env",
...
with DAG(
    ...
    cloudflare_derived__os_usage__v1 = GKEPodOperator(
        ...
        email=["kwindau@mozilla.com"],
        secrets=[
            cloudflare_derived__os_usage__v1_bqetl_cloudflare_os_market_share__cloudflare_auth_token,
        ],
    )
