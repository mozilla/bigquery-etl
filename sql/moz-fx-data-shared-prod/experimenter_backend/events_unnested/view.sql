...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.experimenter_backend.events_unnested`
AS
SELECT
  "experimenter_backend" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.experimenter_backend.events` AS e
CROSS JOIN
