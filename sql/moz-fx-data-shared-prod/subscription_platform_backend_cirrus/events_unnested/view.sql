...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus.events_unnested`
AS
SELECT
  "subscription_platform_backend_cirrus" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend_cirrus.events` AS e
CROSS JOIN
