...
merged_funnels AS (
  SELECT
    COALESCE(login_overall_success_by_service_login_view_aggregated.service) AS service,
    submission_date,
    funnel,
    COALESCE(login_overall_success_by_service_login_view_aggregated.aggregated) AS login_view,
    COALESCE(
