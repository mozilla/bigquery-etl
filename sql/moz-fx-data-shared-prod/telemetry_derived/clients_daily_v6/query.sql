...
clients_summary AS (
  SELECT
    ...
    payload.processes.parent.keyed_scalars.urlbar_picked_autofill_preloaded AS scalar_parent_urlbar_impression_autofill_preloaded,
    payload.processes.parent.keyed_scalars.urlbar_picked_autofill_url AS scalar_parent_urlbar_impression_autofill_url,
