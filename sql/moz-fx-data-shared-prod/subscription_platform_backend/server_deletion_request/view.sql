...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.subscription_platform_backend.server_deletion_request`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.subscription_platform_backend_stable.server_deletion_request_v1`
