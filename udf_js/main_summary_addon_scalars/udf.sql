...
SELECT
  ...
  assert_array_equals([STRUCT("a" as key, true as value), STRUCT("b" as key, false as value)], keyed_boolean_addon_scalars[OFFSET(0)].value),
  assert_equals("foo7", keyed_boolean_addon_scalars[OFFSET(1)].key),
  assert_array_equals([STRUCT("c", false), STRUCT("d", true)], keyed_boolean_addon_scalars[OFFSET(1)].value),
  assert_equals(1, ARRAY_LENGTH(keyed_uint_addon_scalars)),
  assert_equals("foo2", keyed_uint_addon_scalars[OFFSET(0)].key),
  assert_array_equals([STRUCT("a", 17), STRUCT("b", 42)], keyed_uint_addon_scalars[OFFSET(0)].value),
  assert_equals(1, ARRAY_LENGTH(string_addon_scalars)),
  assert_equals("foo3", string_addon_scalars[OFFSET(0)].key),
  assert_equals("blee", string_addon_scalars[OFFSET(0)].value),
  assert_equals(1, ARRAY_LENGTH(keyed_string_addon_scalars)),
  assert_equals("foo4", keyed_string_addon_scalars[OFFSET(0)].key),
  assert_array_equals([STRUCT("a", "yes"), STRUCT("b", "no")], keyed_string_addon_scalars[OFFSET(0)].value),
  assert_equals(1, ARRAY_LENGTH(uint_addon_scalars)),
  assert_equals("foo5", uint_addon_scalars[OFFSET(0)].key),
  assert_equals(17, uint_addon_scalars[OFFSET(0)].value),
  assert_equals(1, ARRAY_LENGTH(boolean_addon_scalars)),
  assert_equals("foo6", boolean_addon_scalars[OFFSET(0)].key),
