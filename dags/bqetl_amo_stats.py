...
with DAG(
    ...
    addons_derived__amo_stats_dau_combined__v1 = bigquery_etl_query(
        task_id="addons_derived__amo_stats_dau_combined__v1",
        destination_table="amo_stats_dau_combined_v1",
        dataset_id="addons_derived",
        project_id="moz-fx-data-shared-prod",
        owner="kik@mozilla.com",
        email=["kik@mozilla.com", "telemetry-alerts@mozilla.com"],
    ...
    addons_derived__dev_amo_stats_dau__v1 = bigquery_etl_query(
        task_id="addons_derived__dev_amo_stats_dau__v1",
        destination_table="dev_amo_stats_dau_v1",
        dataset_id="addons_derived",
        project_id="moz-fx-data-shared-prod",
        owner="kik@mozilla.com",
    ...
    addons_derived__dev_amo_stats_installs__v1 = bigquery_etl_query(
        task_id="addons_derived__dev_amo_stats_installs__v1",
        destination_table="dev_amo_stats_installs_v1",
        dataset_id="addons_derived",
        project_id="moz-fx-data-shared-prod",
        owner="kik@mozilla.com",
        email=["kik@mozilla.com", "lgreco@mozilla.com", "telemetry-alerts@mozilla.com"],
    ...
    addons_derived__firefox_desktop_stats_installs__v1 = bigquery_etl_query(
        task_id="addons_derived__firefox_desktop_stats_installs__v1",
    ...
    amo_prod__amo_stats_dau_legacy_source__v1 = bigquery_etl_query(
        task_id="amo_prod__amo_stats_dau_legacy_source__v1",
        destination_table="amo_stats_dau_legacy_source_v1",
        dataset_id="amo_prod",
        project_id="moz-fx-data-shared-prod",
        owner="kik@mozilla.com",
    ...
    addons_derived__amo_stats_dau_combined__v1.set_upstream(
        addons_derived__fenix_addons_by_client__v1
    )
    ...
    addons_derived__dev_amo_stats_dau__v1.set_upstream(
        addons_derived__amo_stats_dau_combined__v1
    )
    ...
    amo_prod__amo_stats_dau_legacy_source__v1.set_upstream(
        amo_prod__desktop_addons_by_client__v1
    )

    amo_prod__amo_stats_dau_legacy_source__v1.set_upstream(
        amo_prod__fenix_addons_by_client__v1
    )
