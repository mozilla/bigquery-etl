CREATE OR REPLACE PROCEDURE
  event_analysis.get_count_sql(project STRING, dataset STRING, count_name STRING, events ARRAY<STRUCT<category STRING, event_name STRING>>, OUT count_sql STRING)
BEGIN
  ...
  SET count_sql = CONCAT(
    'ARRAY_LENGTH(regexp_extract_all(events, r"', count_regex, '")) AS ', count_name
  );
END;
