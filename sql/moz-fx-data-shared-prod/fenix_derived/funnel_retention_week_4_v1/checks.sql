...
SELECT
  IF(
    ...
    ERROR(
      "Duplicates detected (Expected combined set of values for columns ['first_seen_date', 'first_reported_country', 'first_reported_isp', 'adjust_ad_group', 'adjust_campaign', 'adjust_creative', 'adjust_network', 'install_source'] to be unique.)"
    ),
    NULL
  );
