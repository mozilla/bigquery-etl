...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.org_mozilla_ios_focus.nimbus_targeting_context`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.org_mozilla_ios_focus_stable.nimbus_targeting_context_v1`
