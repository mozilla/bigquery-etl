...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.thunderbird_crashreporter.events_unnested`
AS
SELECT
  "thunderbird_crashreporter" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.thunderbird_crashreporter.events` AS e
CROSS JOIN
