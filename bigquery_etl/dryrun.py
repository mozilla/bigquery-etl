...
SKIP = {
    ...
    *glob.glob("sql/moz-fx-data-shared-prod/regrets_reporter/**/view.sql", recursive=True),  # noqa E501
    *glob.glob("sql/moz-fx-data-shared-prod/regrets_reporter_ucs/**/view.sql", recursive=True),  # noqa E501
