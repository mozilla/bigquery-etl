...
IF
  NOT EXISTS `moz-fx-data-shared-prod.org_mozilla_firefox_derived.experiment_crash_events_live_v1`
  PARTITION BY
    DATE(partition_date)
  OPTIONS
  ...
  FROM
    `moz-fx-data-shared-prod.org_mozilla_firefox_live.crash_v1`
  LEFT JOIN
