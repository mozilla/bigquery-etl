...
class Backfill:
    ...
    override_depends_on_past: Optional[bool] = attr.ib(False)
    ...
    def __str__(self):
        ...
        backfill_str += f"""
            ...
            override_depends_on_past = {self.override_depends_on_past}
            ...
            try:
                ...
                for entry_date, entry in backfills.items():
                    ...
                    backfill = cls(
                        ...
                        override_depends_on_past=entry.get(
                            "override_depends_on_past", False
                        ),
