CREATE OR REPLACE PROCEDURE
  event_analysis.get_funnel_steps_sql(project STRING, dataset STRING, funnel_name STRING, funnel ARRAY<STRUCT<step_name STRING, list ARRAY<STRUCT<category STRING, event_name STRING>>>>, OUT funnel_sql STRING)
BEGIN
