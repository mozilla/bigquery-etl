"""
Generate app-specific views for Glean apps.
...
---
friendly_name: App-specific view for Glean Ping Table
description: |-
            ...
            if output_dir:
                write_sql(
                    ...
                    VIEW_QUERY_TEMPLATE.format(
                        full_view_id=full_view_id, target=underlying_view_id
                    ),
                )
                write_sql(
                    output_dir,
                ...
                original_schema_file = get_table_dir(output_dir, underlying_view_id) / "schema.yaml"
