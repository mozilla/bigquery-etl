-- Query generated by: templates/unnest_parquet_view.sql.py clients_daily_v6 telemetry_raw.clients_daily_v6
...
FROM
  `moz-fx-data-derived-datasets.telemetry_raw.clients_daily_v6`
