...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.events_unnested`
AS
SELECT
  "firefox_enterprise_desktop" AS normalized_app_id,
...
FROM
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.events` AS e
CROSS JOIN
