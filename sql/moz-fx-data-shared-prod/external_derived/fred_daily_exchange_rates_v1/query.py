...
if __name__ == "__main__":
    ...
    results_df = pd.DataFrame(columns=["submission_date", "conversion_type", "exchange_rate"])

    # TEMP - hardcoding dates right now
    ...
    for k, v in exchange_rates.items():
        ...
        new_data_df = new_data_df[["submission_date", "conversion_type", "exchange_rate"]]
    ...
    print("Note - this ETL is expected to only have new data for business days, not weekends or holidays")
