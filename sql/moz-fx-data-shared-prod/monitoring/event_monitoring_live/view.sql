...
SELECT
  ...
  total_events
FROM
  `moz-fx-data-shared-prod.thunderbird_crashreporter_derived.event_monitoring_live_v1`
WHERE
  DATE(submission_date) > DATE_SUB(CURRENT_DATE(), INTERVAL 2 DAY)
UNION ALL
SELECT
...
SELECT
  ...
  total_events
FROM
  `moz-fx-data-shared-prod.subscription_platform_frontend_derived.event_monitoring_live_v1`
WHERE
  DATE(submission_date) > DATE_SUB(CURRENT_DATE(), INTERVAL 2 DAY)
UNION ALL
SELECT
...
SELECT
  ...
  total_events
FROM
  `moz-fx-data-shared-prod.mdn_mcp_derived.event_monitoring_live_v1`
WHERE
  DATE(submission_date) > DATE_SUB(CURRENT_DATE(), INTERVAL 2 DAY)
UNION ALL
SELECT
  ...
  total_events
FROM
  `moz-fx-data-shared-prod.moz_backstage_derived.event_monitoring_live_v1`
WHERE
  DATE(submission_date) > DATE_SUB(CURRENT_DATE(), INTERVAL 2 DAY)
UNION ALL
SELECT
