...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.temp_fog_initial_state`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_enterprise_desktop_stable.temp_fog_initial_state_v1`
