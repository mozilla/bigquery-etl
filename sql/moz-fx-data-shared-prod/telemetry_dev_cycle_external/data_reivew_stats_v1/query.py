...
# def download_data_review_stats(bugs):
#     rows = []

#     for bug in bugs:
#         bug_id = bug["id"]
#         for changeset in bug["history"]:
#             when = dateutil.parser.parse(changeset["when"], ignoretz=True).strftime(
#                 "%Y-%m-%d %H:%M:%S"
#             )
#             who = changeset["who"]
