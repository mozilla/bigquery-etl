...
SELECT
  * EXCEPT (map_sum_aggregates),
  ...
  map_sum_aggregates[OFFSET(17)].map AS scalar_parent_urlbar_picked_autofill,
  map_sum_aggregates[OFFSET(18)].map AS scalar_parent_urlbar_picked_autofill_adaptive,
  map_sum_aggregates[OFFSET(19)].map AS scalar_parent_urlbar_picked_autofill_origin,
  map_sum_aggregates[OFFSET(20)].map AS scalar_parent_urlbar_picked_autofill_url,
  map_sum_aggregates[OFFSET(21)].map AS scalar_parent_urlbar_picked_bookmark_sum,
  map_sum_aggregates[OFFSET(22)].map AS scalar_parent_urlbar_picked_dynamic_sum,
  map_sum_aggregates[OFFSET(23)].map AS scalar_parent_urlbar_picked_extension_sum,
  map_sum_aggregates[OFFSET(24)].map AS scalar_parent_urlbar_picked_formhistory_sum,
  map_sum_aggregates[OFFSET(25)].map AS scalar_parent_urlbar_picked_history_sum,
  map_sum_aggregates[OFFSET(26)].map AS scalar_parent_urlbar_picked_keyword_sum,
  map_sum_aggregates[OFFSET(27)].map AS scalar_parent_urlbar_picked_remotetab_sum,
  map_sum_aggregates[OFFSET(28)].map AS scalar_parent_urlbar_picked_searchengine_sum,
  map_sum_aggregates[OFFSET(29)].map AS scalar_parent_urlbar_picked_searchsuggestion_sum,
  map_sum_aggregates[OFFSET(30)].map AS scalar_parent_urlbar_picked_switchtab_sum,
  map_sum_aggregates[OFFSET(31)].map AS scalar_parent_urlbar_picked_tabtosearch_sum,
  map_sum_aggregates[OFFSET(32)].map AS scalar_parent_urlbar_picked_tip_sum,
  map_sum_aggregates[OFFSET(33)].map AS scalar_parent_urlbar_picked_topsite_sum,
  map_sum_aggregates[OFFSET(34)].map AS scalar_parent_urlbar_picked_unknown_sum,
  map_sum_aggregates[OFFSET(35)].map AS scalar_parent_urlbar_picked_visiturl_sum,
  map_sum_aggregates[OFFSET(36)].map AS search_with_ads,
  map_sum_aggregates[OFFSET(37)].map AS ad_clicks,
  map_sum_aggregates[OFFSET(38)].map AS search_content_urlbar_sum,
  map_sum_aggregates[OFFSET(39)].map AS search_content_urlbar_searchmode_sum,
  map_sum_aggregates[OFFSET(40)].map AS search_content_contextmenu_sum,
  map_sum_aggregates[OFFSET(41)].map AS search_content_about_home_sum,
  map_sum_aggregates[OFFSET(42)].map AS search_content_about_newtab_sum,
  map_sum_aggregates[OFFSET(43)].map AS search_content_searchbar_sum,
  map_sum_aggregates[OFFSET(44)].map AS search_content_system_sum,
  map_sum_aggregates[OFFSET(45)].map AS search_content_webextension_sum,
  map_sum_aggregates[OFFSET(46)].map AS search_content_tabhistory_sum,
  map_sum_aggregates[OFFSET(47)].map AS search_content_reload_sum,
  map_sum_aggregates[OFFSET(48)].map AS search_content_unknown_sum,
  map_sum_aggregates[OFFSET(49)].map AS search_withads_urlbar_sum,
  map_sum_aggregates[OFFSET(50)].map AS search_withads_urlbar_searchmode_sum,
  map_sum_aggregates[OFFSET(51)].map AS search_withads_contextmenu_sum,
  map_sum_aggregates[OFFSET(52)].map AS search_withads_about_home_sum,
  map_sum_aggregates[OFFSET(53)].map AS search_withads_about_newtab_sum,
  map_sum_aggregates[OFFSET(54)].map AS search_withads_searchbar_sum,
  map_sum_aggregates[OFFSET(55].map AS search_withads_system_sum,
  map_sum_aggregates[OFFSET(56)].map AS search_withads_webextension_sum,
  map_sum_aggregates[OFFSET(57)].map AS search_withads_tabhistory_sum,
  map_sum_aggregates[OFFSET(58)].map AS search_withads_reload_sum,
  map_sum_aggregates[OFFSET(59)].map AS search_withads_unknown_sum,
  map_sum_aggregates[OFFSET(60)].map AS search_adclicks_urlbar_sum,
  map_sum_aggregates[OFFSET(61)].map AS search_adclicks_urlbar_searchmode_sum,
  map_sum_aggregates[OFFSET(62)].map AS search_adclicks_contextmenu_sum,
  map_sum_aggregates[OFFSET(63)].map AS search_adclicks_about_home_sum,
  map_sum_aggregates[OFFSET(64)].map AS search_adclicks_about_newtab_sum,
  map_sum_aggregates[OFFSET(65)].map AS search_adclicks_searchbar_sum,
  map_sum_aggregates[OFFSET(66)].map AS search_adclicks_system_sum,
  map_sum_aggregates[OFFSET(67)].map AS search_adclicks_webextension_sum,
  map_sum_aggregates[OFFSET(68)].map AS search_adclicks_tabhistory_sum,
  map_sum_aggregates[OFFSET(69)].map AS search_adclicks_reload_sum,
  map_sum_aggregates[OFFSET(70)].map AS search_adclicks_unknown_sum,
  map_sum_aggregates[OFFSET(71)].map AS search_content_urlbar_handoff_sum,
  map_sum_aggregates[OFFSET(72)].map AS search_withads_urlbar_handoff_sum,
  map_sum_aggregates[OFFSET(73)].map AS search_adclicks_urlbar_handoff_sum,
  map_sum_aggregates[OFFSET(74)].map AS contextual_services_quicksuggest_click_sum,
  map_sum_aggregates[OFFSET(75)].map AS contextual_services_quicksuggest_impression_sum,
  map_sum_aggregates[OFFSET(76)].map AS contextual_services_quicksuggest_help_sum,
  map_sum_aggregates[
    OFFSET(77)
  ...
  map_sum_aggregates[OFFSET(79)].map AS contextual_services_quicksuggest_block_nonsponsored_sum,
  map_sum_aggregates[OFFSET(80)].map AS contextual_services_quicksuggest_block_sponsored_sum,
  map_sum_aggregates[
    OFFSET(81)
  ...
  map_sum_aggregates[OFFSET(87)].map AS contextual_services_topsites_click_sum,
  map_sum_aggregates[OFFSET(88)].map AS contextual_services_topsites_impression_sum,
FROM
  udf_aggregates
