...
with DAG(
    ...
    checks__warn_firefox_ios_derived__attribution_clients__v1 = bigquery_dq_check(
        task_id="checks__warn_firefox_ios_derived__attribution_clients__v1",
        source_table="attribution_clients_v1",
    ...
    checks__warn_focus_android_derived__attribution_clients__v1 = bigquery_dq_check(
        task_id="checks__warn_focus_android_derived__attribution_clients__v1",
        source_table="attribution_clients_v1",
    ...
    checks__warn_focus_ios_derived__attribution_clients__v1 = bigquery_dq_check(
        task_id="checks__warn_focus_ios_derived__attribution_clients__v1",
        source_table="attribution_clients_v1",
    ...
    checks__warn_klar_android_derived__attribution_clients__v1 = bigquery_dq_check(
        task_id="checks__warn_klar_android_derived__attribution_clients__v1",
        source_table="attribution_clients_v1",
    ...
    checks__warn_klar_ios_derived__attribution_clients__v1 = bigquery_dq_check(
        task_id="checks__warn_klar_ios_derived__attribution_clients__v1",
        source_table="attribution_clients_v1",
    ...
    checks__warn_firefox_ios_derived__attribution_clients__v1.set_upstream(
    ...
    checks__warn_focus_android_derived__attribution_clients__v1.set_upstream(
    ...
    checks__warn_focus_ios_derived__attribution_clients__v1.set_upstream(
    ...
    checks__warn_klar_android_derived__attribution_clients__v1.set_upstream(
