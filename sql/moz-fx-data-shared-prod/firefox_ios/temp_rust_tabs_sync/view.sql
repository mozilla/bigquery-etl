...
SELECT
  ...
  STRUCT(
    STRUCT(
      ...
      metrics.labeled_counter.rust_tabs_sync_failure_reason,
      metrics.labeled_counter.rust_tabs_sync_incoming,
      metrics.labeled_counter.rust_tabs_sync_outgoing
    ) AS `labeled_counter`,
    STRUCT(
      metrics.string.rust_tabs_sync_uid,
