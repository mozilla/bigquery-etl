WITH table_row_counts AS (
  SELECT
    'moz-fx-data-marketing-prod.searchconsole_addons.searchdata_url_impression' AS table_id,
    COUNT(*) AS row_count
  FROM
  ...
  UNION ALL
  SELECT
    'moz-fx-data-marketing-prod.searchconsole_blog.searchdata_url_impression' AS table_id,
    COUNT(*) AS row_count
  FROM
  ...
  UNION ALL
  SELECT
    'moz-fx-data-marketing-prod.searchconsole_getpocket.searchdata_url_impression' AS table_id,
    COUNT(*) AS row_count
  FROM
  ...
  UNION ALL
  SELECT
    'moz-fx-data-marketing-prod.searchconsole_support.searchdata_url_impression' AS table_id,
    COUNT(*) AS row_count
  FROM
  ...
  UNION ALL
  SELECT
    'moz-fx-data-marketing-prod.searchconsole_www.searchdata_url_impression' AS table_id,
    COUNT(*) AS row_count
  FROM
