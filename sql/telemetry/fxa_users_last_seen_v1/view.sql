CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.telemetry.fxa_users_last_seen_v1`
AS
SELECT
  ...
  CAST(
    SAFE.LOG(days_seen_no_monitor_bits & -days_seen_no_monitor_bits, 2) AS INT64
  ) AS days_since_seen_no_monitor,
  *
FROM
