...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.firefox_enterprise_desktop.third_party_modules`
AS
SELECT
  * REPLACE (
...
FROM
  `moz-fx-data-shared-prod.firefox_enterprise_desktop_stable.third_party_modules_v1`
