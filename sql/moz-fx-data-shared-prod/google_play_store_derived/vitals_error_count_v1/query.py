"""Script to pull Vitals Error Count metrics from Google API."""
...
class Metric:
    ...
    def from_dict(cls, kwargs: Dict[Any, Any]) -> Self:
        ...
        return cls(
            ...
            value=int(kwargs["decimalValue"]["value"]),
        )
...
class Row:
    ...
    def merge_and_dump(self) -> Dict[str, Union[str, int]]:
...
def fetch_data(
    ...
    url = f"https://playdeveloperreporting.googleapis.com/v1beta1/apps/{app_name}/errorCountMetricSet:query"
    timeout_seconds = 20
...
if __name__ == "__main__":
    ...
    parser.add_argument("--table_name", type=str, default="vitals_error_count_v1")
    parser.add_argument(
