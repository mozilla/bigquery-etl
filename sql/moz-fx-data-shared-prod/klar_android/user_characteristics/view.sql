...
CREATE OR REPLACE VIEW
  `moz-fx-data-shared-prod.klar_android.user_characteristics`
AS
SELECT
  ...
  STRUCT(
    STRUCT(
      ...
      metrics.boolean.characteristics_wgpu_is_fallback_adapter
    ) AS `boolean`,
    STRUCT(
    ...
    STRUCT(
      ...
      metrics.string.characteristics_canvasdata10_software,
      metrics.string.characteristics_canvasdata11_webgl_software,
      metrics.string.characteristics_canvasdata12_fingerprintjs1_software,
      metrics.string.characteristics_canvasdata13_fingerprintjs2_software,
      metrics.string.characteristics_canvasdata1_software,
      metrics.string.characteristics_canvasdata2_software,
      metrics.string.characteristics_canvasdata3_software,
      metrics.string.characteristics_canvasdata4_software,
      metrics.string.characteristics_canvasdata5_software,
      metrics.string.characteristics_canvasdata6_software,
      metrics.string.characteristics_canvasdata7_software,
      metrics.string.characteristics_canvasdata8_software,
      metrics.string.characteristics_canvasdata9_software,
      metrics.string.characteristics_clientrects_element_gbcr_01,
      metrics.string.characteristics_clientrects_element_gbcr_02,
      metrics.string.characteristics_clientrects_element_gbcr_03,
      metrics.string.characteristics_clientrects_element_gbcr_04,
      metrics.string.characteristics_clientrects_element_gbcr_05,
      metrics.string.characteristics_clientrects_element_gbcr_06,
      metrics.string.characteristics_clientrects_element_gbcr_07,
      metrics.string.characteristics_clientrects_element_gbcr_08,
      metrics.string.characteristics_clientrects_element_gbcr_09,
      metrics.string.characteristics_clientrects_element_gbcr_10,
      metrics.string.characteristics_clientrects_element_gbcr_11,
      metrics.string.characteristics_clientrects_element_gbcr_12,
      metrics.string.characteristics_clientrects_element_gcr_01,
      metrics.string.characteristics_clientrects_element_gcr_02,
      metrics.string.characteristics_clientrects_element_gcr_03,
      metrics.string.characteristics_clientrects_element_gcr_04,
      metrics.string.characteristics_clientrects_element_gcr_05,
      metrics.string.characteristics_clientrects_element_gcr_06,
      metrics.string.characteristics_clientrects_element_gcr_07,
      metrics.string.characteristics_clientrects_element_gcr_08,
      metrics.string.characteristics_clientrects_element_gcr_09,
      metrics.string.characteristics_clientrects_element_gcr_10,
      metrics.string.characteristics_clientrects_element_gcr_11,
      metrics.string.characteristics_clientrects_element_gcr_12,
      metrics.string.characteristics_clientrects_emoji_01,
      metrics.string.characteristics_clientrects_emoji_02,
      metrics.string.characteristics_clientrects_emoji_03,
      metrics.string.characteristics_clientrects_emoji_04,
      metrics.string.characteristics_clientrects_emoji_05,
      metrics.string.characteristics_clientrects_emoji_06,
      metrics.string.characteristics_clientrects_emoji_font_family,
      metrics.string.characteristics_clientrects_ghost_dimensions,
      metrics.string.characteristics_clientrects_known_dimensions,
      metrics.string.characteristics_clientrects_range_gbcr_01,
      metrics.string.characteristics_clientrects_range_gbcr_02,
      metrics.string.characteristics_clientrects_range_gbcr_03,
      metrics.string.characteristics_clientrects_range_gbcr_04,
      metrics.string.characteristics_clientrects_range_gbcr_05,
      metrics.string.characteristics_clientrects_range_gbcr_06,
      metrics.string.characteristics_clientrects_range_gbcr_07,
      metrics.string.characteristics_clientrects_range_gbcr_08,
      metrics.string.characteristics_clientrects_range_gbcr_09,
      metrics.string.characteristics_clientrects_range_gbcr_10,
      metrics.string.characteristics_clientrects_range_gbcr_11,
      metrics.string.characteristics_clientrects_range_gbcr_12,
      metrics.string.characteristics_clientrects_range_gcr_01,
      metrics.string.characteristics_clientrects_range_gcr_02,
      metrics.string.characteristics_clientrects_range_gcr_03,
      metrics.string.characteristics_clientrects_range_gcr_04,
      metrics.string.characteristics_clientrects_range_gcr_05,
      metrics.string.characteristics_clientrects_range_gcr_06,
      metrics.string.characteristics_clientrects_range_gcr_07,
      metrics.string.characteristics_clientrects_range_gcr_08,
      metrics.string.characteristics_clientrects_range_gcr_09,
      metrics.string.characteristics_clientrects_range_gcr_10,
      metrics.string.characteristics_clientrects_range_gcr_11,
      metrics.string.characteristics_clientrects_range_gcr_12,
      metrics.string.characteristics_clientrects_text_font_family,
      metrics.string.characteristics_fonts_variant_c_allowlisted,
      metrics.string.characteristics_fonts_variant_c_nonallowlisted,
      metrics.string.characteristics_fonts_variant_d_allowlisted,
      metrics.string.characteristics_fonts_variant_d_nonallowlisted,
    ...
    STRUCT(
      ...
      metrics.text2.characteristics_canvasdata10_raw,
      metrics.text2.characteristics_canvasdata10_software_raw,
      metrics.text2.characteristics_canvasdata11_webgl_raw,
      metrics.text2.characteristics_canvasdata11_webgl_software_raw,
      metrics.text2.characteristics_canvasdata12_fingerprintjs1_raw,
      metrics.text2.characteristics_canvasdata12_fingerprintjs1_software_raw,
      metrics.text2.characteristics_canvasdata13_fingerprintjs2_raw,
      metrics.text2.characteristics_canvasdata13_fingerprintjs2_software_raw,
      metrics.text2.characteristics_canvasdata1_raw,
      metrics.text2.characteristics_canvasdata1_software_raw,
      metrics.text2.characteristics_canvasdata2_raw,
      metrics.text2.characteristics_canvasdata2_software_raw,
      metrics.text2.characteristics_canvasdata3_raw,
      metrics.text2.characteristics_canvasdata3_software_raw,
      metrics.text2.characteristics_canvasdata4_raw,
      metrics.text2.characteristics_canvasdata4_software_raw,
      metrics.text2.characteristics_canvasdata5_raw,
      metrics.text2.characteristics_canvasdata5_software_raw,
      metrics.text2.characteristics_canvasdata6_raw,
      metrics.text2.characteristics_canvasdata6_software_raw,
      metrics.text2.characteristics_canvasdata7_raw,
      metrics.text2.characteristics_canvasdata7_software_raw,
      metrics.text2.characteristics_canvasdata8_raw,
      metrics.text2.characteristics_canvasdata8_software_raw,
      metrics.text2.characteristics_canvasdata9_raw,
