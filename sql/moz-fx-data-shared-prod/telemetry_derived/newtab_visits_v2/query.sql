...
SELECT
  *,
  CASE
    WHEN (newtab_open_source = 'about:home') AND (newtab_homepage_category = 'enabled') THEN 'default'
    WHEN (newtab_open_source = 'about:newtab') AND (newtab_newtab_category = 'enabled') THEN 'default'
    WHEN newtab_open_source = 'about:welcome' THEN 'welcome'
    WHEN (newtab_open_source = 'about:home') AND (newtab_homepage_category != 'enabled') THEN 'home - non-default'
    WHEN (newtab_open_source = 'about:newtab') AND (newtab_newtab_category != 'enabled') THEN 'newtab - non-default'
    ELSE "other"
  END AS default_ui,
FROM
