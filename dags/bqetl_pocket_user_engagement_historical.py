...
Built from bigquery-etl repo, [`dags/bqetl_pocket_user_engagement_historical.py`](https://github.com/mozilla/bigquery-etl/blob/generated-sql/dags/bqetl_pocket_user_engagement_historical.py)
...
with DAG(
    ...
    braze_external__pocket_user_engagement_historical__v1 = GKEPodOperator(
        task_id="braze_external__pocket_user_engagement_historical__v1",
        arguments=[
            "python",
            "sql/moz-fx-data-shared-prod/braze_external/pocket_user_engagement_historical_v1/query.py",
        ]
        + [
