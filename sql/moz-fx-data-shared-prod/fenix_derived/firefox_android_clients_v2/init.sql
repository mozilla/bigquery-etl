...
SELECT
  client_id,
  sample_id,
  _current.first_seen_date AS first_seen_date,
  _current.first_reported_country AS first_reported_country,
  _current.first_reported_isp AS first_reported_isp,
  _current.channel AS channel,
  _current.device_manufacturer AS device_manufacturer,
  _current.device_model AS device_model,
  _current.os_version AS os_version,
